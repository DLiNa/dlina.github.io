...
setTimeout(function() { console.log('load36'); var  at = nodes[0],au = nodes[1],av = nodes[2] ; /* nodes.push(); */ links.push( {source: at , target: av },{source: at , target: au },{source: au , target: av } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfter Auftritt';
}, 175000);
...
setTimeout(function() { console.log('load38'); var  ab = nodes[0],ap = {id: 'ap', name:'bürgermeister'},ar = {id: 'ar', name:'sperling'} ; nodes.push( ap,ar ); links.push( {source: ap , target: ar },{source: ab , target: ar },{source: ab , target: ap } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '14. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierzehnter Auftritt';
}, 185000);
...
setTimeout(function() { console.log('load49'); var  ag = nodes[0],ap = {id: 'ap', name:'bürgermeister'},aq = nodes[1],bb = {id: 'bb', name:'kellner'} ; nodes.push( ap,bb ); links.push( {source: aq , target: bb },{source: ag , target: aq },{source: ag , target: ap },{source: ag , target: bb },{source: ap , target: aq },{source: ap , target: bb } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt';
}, 240000);

setTimeout(function() { console.log('remv49'); var rm = [ 'ag','bb' ]; rmNodes(rm); rmLinks(rm); start(); }, 243750);

setTimeout(function() { console.log('load50'); var  ab = {id: 'ab', name:'nachtwächter'},ac = {id: 'ac', name:'pemperl'},ap = nodes[0],aq = nodes[1] ; nodes.push( ab,ac ); links.push( {source: ab , target: ac },{source: ab , target: ap },{source: ab , target: aq },{source: ac , target: ap },{source: ac , target: aq },{source: ap , target: aq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt';
}, 245000);
