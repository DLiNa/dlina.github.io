...
setTimeout(function() { console.log('load10'); var  ag = nodes[0],ai = nodes[1] ; /* nodes.push(); */ links.push( {source: ag , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt';
}, 45000);
...
setTimeout(function() { console.log('load25'); var  aa = {id: 'aa', name:'zar'},ae = {id: 'ae', name:'lefort'},af = nodes[0],ag = nodes[1] ; nodes.push( aa,ae ); links.push( {source: ae , target: af },{source: ae , target: ag },{source: aa , target: ae },{source: aa , target: af },{source: aa , target: ag },{source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt';
}, 120000);
...
setTimeout(function() { console.log('load36'); var  ab = nodes[0],ac = {id: 'ac', name:'chor'},ad = {id: 'ad', name:'marie'},ag = {id: 'ag', name:'van_bett'},as = {id: 'as', name:'ratsdiener'} ; nodes.push( ac,ad,ag,as ); links.push( {source: ac , target: ag },{source: ac , target: ad },{source: ac , target: as },{source: ag , target: as },{source: ad , target: ag },{source: ad , target: as },{source: ab , target: ac },{source: ab , target: ag },{source: ab , target: ad },{source: ab , target: as } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt';
}, 175000);

setTimeout(function() { console.log('remv36'); var rm = [ 'ac','ad','ab','as' ]; rmNodes(rm); rmLinks(rm); start(); }, 178750);

setTimeout(function() { console.log('load37'); var  aa = {id: 'aa', name:'zar'},ae = {id: 'ae', name:'lefort'},ag = nodes[0],aj = {id: 'aj', name:'marquis'} ; nodes.push( aa,ae,aj ); links.push( {source: ag , target: aj },{source: aa , target: ag },{source: aa , target: ae },{source: aa , target: aj },{source: ae , target: ag },{source: ae , target: aj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfter Auftritt';
}, 180000);
