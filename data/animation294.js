setTimeout(function() { console.log('load1'); var  aa = {id: 'aa', name:'chloe'},ab = {id: 'ab', name:'lamon'} ; nodes.push( aa,ab ); links.push( {source: aa , target: ab } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt.';
}, 0);
...
setTimeout(function() { console.log('load6'); var  af = {id: 'af', name:'pyrhus'},ag = {id: 'ag', name:'arates'} ; nodes.push( af,ag ); links.push( {source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt.';
}, 25000);
...
setTimeout(function() { console.log('load8'); var  ab = {id: 'ab', name:'lamon'},ac = nodes[0],af = nodes[1],ah = {id: 'ah', name:'bedienter'} ; nodes.push( ab,ah ); links.push( {source: af , target: ah },{source: ab , target: ah },{source: ab , target: af },{source: ab , target: ac },{source: ac , target: ah },{source: ac , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt.';
}, 35000);
...
setTimeout(function() { console.log('load13'); var  aa = {id: 'aa', name:'chloe'},ad = {id: 'ad', name:'alcimna'},ah = {id: 'ah', name:'bedienter'} ; nodes.push( aa,ad,ah ); links.push( {source: ad , target: ah },{source: aa , target: ad },{source: aa , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt.';
}, 60000);

setTimeout(function() { console.log('remv13'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 63750);

setTimeout(function() { console.log('load14'); var  aa = nodes[0],ad = nodes[1],ag = {id: 'ag', name:'arates'},ah = nodes[2] ; nodes.push( ag ); links.push( {source: ag , target: ah },{source: ad , target: ag },{source: ad , target: ah },{source: aa , target: ag },{source: aa , target: ah },{source: aa , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweyter Auftritt.';
}, 65000);

setTimeout(function() { console.log('remv14'); var rm = [ 'ag','ah','aa' ]; rmNodes(rm); rmLinks(rm); start(); }, 68750);

setTimeout(function() { console.log('load15'); var  ad = nodes[0],am = {id: 'am', name:'erste_aufwærterin'},an = {id: 'an', name:'zweyte_aufwærterin'} ; nodes.push( am,an ); links.push( {source: am , target: an },{source: ad , target: am },{source: ad , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt.';
}, 70000);
