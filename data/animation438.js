...
setTimeout(function() { console.log('load12'); var  ad = {id: 'ad', name:'eginhard'},ag = nodes[0],ak = nodes[1],ak = nodes[1],ak = nodes[1] ; nodes.push( ad,ak ); links.push( {source: ad , target: ak },{source: ad , target: ag },{source: ad , target: ak },{source: ad , target: ak },{source: ag , target: ak },{source: ag , target: ak },{source: ag , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Scene.';
}, 55000);
