...
setTimeout(function() { console.log('load2'); var  ab = nodes[1],ad = {id: 'ad', name:'eginhard'} ; nodes.push( ad ); links.push( {source: ab , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Scene.';
}, 5000);
...
setTimeout(function() { console.log('load4'); var  aa = nodes[0],ab = {id: 'ab', name:'emma'},af = nodes[2],ag = nodes[3],ah = nodes[4],ai = nodes[5] ; nodes.push( ab ); links.push( {source: ab , target: ai },{source: ab , target: af },{source: ab , target: ah },{source: ab , target: ag },{source: af , target: ai },{source: af , target: ah },{source: af , target: ag },{source: ah , target: ai },{source: ag , target: ai },{source: ag , target: ah },{source: aa , target: ab },{source: aa , target: ai },{source: aa , target: af },{source: aa , target: ah },{source: aa , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Scene.';
}, 15000);

setTimeout(function() { console.log('remv4'); var rm = [ 'ab','ai','af','aa' ]; rmNodes(rm); rmLinks(rm); start(); }, 18750);

setTimeout(function() { console.log('load5'); var  ag = nodes[3],ah = nodes[4] ; /* nodes.push(); */ links.push( {source: ag , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Scene.';
}, 20000);
...
setTimeout(function() { console.log('load12'); var  ad = {id: 'ad', name:'eginhard'},ag = nodes[2],ak = nodes[4],ak = nodes[4],ak = nodes[4] ; nodes.push( ad ); links.push( {source: ad , target: ak },{source: ad , target: ag },{source: ad , target: ak },{source: ad , target: ak },{source: ag , target: ak },{source: ag , target: ak },{source: ag , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Scene.';
}, 55000);
...
setTimeout(function() { console.log('load27'); var  ab = nodes[0],ad = nodes[1],ah = nodes[3] ; /* nodes.push(); */ links.push( {source: ad , target: ah },{source: ab , target: ad },{source: ab , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Scene.';
}, 130000);
