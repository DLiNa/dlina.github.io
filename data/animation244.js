...
setTimeout(function() { console.log('load31'); var  ac = {id: 'ac', name:'cato'},ad = nodes[0],ae = {id: 'ae', name:'artaban'},ae = {id: 'ae', name:'artaban'},ai = nodes[1] ; nodes.push( ac,ae ); links.push( {source: ae , target: ai },{source: ad , target: ae },{source: ad , target: ai },{source: ad , target: ae },{source: ac , target: ae },{source: ac , target: ad },{source: ac , target: ai },{source: ac , target: ae },{source: ae , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Der achte Auftritt.';
}, 150000);
