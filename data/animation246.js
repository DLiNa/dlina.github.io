...
setTimeout(function() { console.log('load3');nodes.sort(compare); /* aa ab ac ad ae af */ var  aa = nodes[0] ,ab = {id: 'ab', name:'hofmeisterin'},ac = {id: 'ac', name:'ein_knabe'},ad = {id: 'ad', name:'knaben'},ae = {id: 'ae', name:'der_jungere'},af = {id: 'af', name:'der_ältere'} ; nodes.push( ab,ac,ad,ae,af ); links.push( {source: ab , target: ac },{source: ab , target: ad },{source: ab , target: ae },{source: ab , target: af },{source: ab , target: ae },{source: ac , target: ad },{source: ac , target: ae },{source: ac , target: af },{source: ac , target: ae },{source: aa , target: ab },{source: aa , target: ac },{source: aa , target: ad },{source: aa , target: ae },{source: aa , target: af },{source: aa , target: ae },{source: ad , target: ae },{source: ad , target: af },{source: ad , target: ae },{source: ae , target: af },{source: ae , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt.';
}, 10000);
...
setTimeout(function() { console.log('load5');nodes.sort(compare); /* aa ag */ var  aa = nodes[0] ,ag = {id: 'ag', name:'jason'} ; nodes.push( ag ); links.push( {source: aa , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Letzter Auftritt.';
}, 20000);
