...
setTimeout(function() { console.log('load5'); var  ab = nodes[1],ae = {id: 'ae', name:'die_zweite_magd'},af = nodes[2],ag = {id: 'ag', name:'der_büttel'} ; nodes.push( ae,ag ); links.push( {source: ae , target: af },{source: ae , target: ag },{source: ab , target: ae },{source: ab , target: af },{source: ab , target: ag },{source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 20000);
