...
setTimeout(function() { console.log('load39'); var  ag = nodes[0],am = nodes[1],av = {id: 'av', name:'eurytimos'},ba = {id: 'ba', name:'der_blinde'},bt = nodes[2],bu = nodes[3],bv = nodes[4],cd = nodes[6],ce = nodes[7],cf = nodes[8],cf = nodes[8] ; nodes.push( av,ba ); links.push( {source: ag , target: bt },{source: ag , target: ba },{source: ag , target: bu },{source: ag , target: cd },{source: ag , target: am },{source: ag , target: cf },{source: ag , target: av },{source: ag , target: bv },{source: ag , target: ce },{source: ag , target: cf },{source: bt , target: bu },{source: bt , target: cd },{source: bt , target: cf },{source: bt , target: bv },{source: bt , target: ce },{source: bt , target: cf },{source: ba , target: bt },{source: ba , target: bu },{source: ba , target: cd },{source: ba , target: cf },{source: ba , target: bv },{source: ba , target: ce },{source: ba , target: cf },{source: bu , target: cd },{source: bu , target: cf },{source: bu , target: bv },{source: bu , target: ce },{source: bu , target: cf },{source: cd , target: cf },{source: cd , target: ce },{source: cd , target: cf },{source: am , target: bt },{source: am , target: ba },{source: am , target: bu },{source: am , target: cd },{source: am , target: cf },{source: am , target: av },{source: am , target: bv },{source: am , target: ce },{source: am , target: cf },{source: av , target: bt },{source: av , target: ba },{source: av , target: bu },{source: av , target: cd },{source: av , target: cf },{source: av , target: bv },{source: av , target: ce },{source: av , target: cf },{source: bv , target: cd },{source: bv , target: cf },{source: bv , target: ce },{source: bv , target: cf },{source: ce , target: cf },{source: ce , target: cf } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 190000);
