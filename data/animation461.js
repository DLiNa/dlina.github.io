...
setTimeout(function() { console.log('load5'); var  aa = nodes[0],ac = nodes[1],af = nodes[2],ag = {id: 'ag', name:'diokles'} ; nodes.push( af,ag ); links.push( {source: af , target: ag },{source: aa , target: af },{source: aa , target: ac },{source: aa , target: ag },{source: ac , target: af },{source: ac , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Vorspiel'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Szene';
}, 20000);

setTimeout(function() { console.log('remv5'); var rm = [ 'ac','ag' ]; rmNodes(rm); rmLinks(rm); start(); }, 23750);

setTimeout(function() { console.log('load6'); var  aa = nodes[0],af = nodes[1] ; /* nodes.push(); */ links.push( {source: aa , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Vorspiel'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechste Szene';
}, 25000);
...
setTimeout(function() { console.log('load12'); var  aj = nodes[0],ak = {id: 'ak', name:'bio'},al = {id: 'al', name:'phenippe'} ; nodes.push( ak,al ); links.push( {source: aj , target: al },{source: aj , target: ak },{source: ak , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 55000);
...
setTimeout(function() { console.log('load30'); var  ba = nodes[0] ; /* nodes.push(); */ links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Szene';
}, 145000);
...
setTimeout(function() { console.log('load50'); var  ac = nodes[0],af = {id: 'af', name:'stimme_philaretes'},ag = nodes[1],ah = nodes[2],av = {id: 'av', name:'eurytimos'},ba = {id: 'ba', name:'der_blinde'},cg = nodes[3] ; nodes.push( af,av,ba,cg ); links.push( {source: ag , target: ba },{source: ag , target: cg },{source: ag , target: ah },{source: ag , target: av },{source: ba , target: cg },{source: ac , target: ag },{source: ac , target: ba },{source: ac , target: cg },{source: ac , target: ah },{source: ac , target: af },{source: ac , target: av },{source: ah , target: ba },{source: ah , target: cg },{source: ah , target: av },{source: af , target: ag },{source: af , target: ba },{source: af , target: cg },{source: af , target: ah },{source: af , target: av },{source: av , target: ba },{source: av , target: cg } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnte Szene';
}, 245000);
