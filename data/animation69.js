...
setTimeout(function() { console.log('load18'); var  ae = {id: 'ae', name:'bernhardy'},ah = {id: 'ah', name:'eugen'},am = nodes[1] ; nodes.push( ae,ah ); links.push( {source: ah , target: am },{source: ae , target: ah },{source: ae , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '12. Auftritt';
}, 85000);
