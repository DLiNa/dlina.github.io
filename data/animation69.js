...
setTimeout(function() { console.log('load2'); var  aa = nodes[0],ad = nodes[1],ae = {id: 'ae', name:'bernhardy'},af = {id: 'af', name:'josephine'},ag = {id: 'ag', name:'erster_gast'},ah = {id: 'ah', name:'eugen'} ; nodes.push( ae,af,ag,ah ); links.push( {source: ae , target: af },{source: ae , target: ag },{source: ae , target: ah },{source: ad , target: ae },{source: ad , target: af },{source: ad , target: ag },{source: ad , target: ah },{source: aa , target: ae },{source: aa , target: ad },{source: aa , target: af },{source: aa , target: ag },{source: aa , target: ah },{source: af , target: ag },{source: af , target: ah },{source: ag , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '2. Auftritt';
}, 5000);
...
setTimeout(function() { console.log('load4'); var  aa = {id: 'aa', name:'kissling'},ai = nodes[0],al = {id: 'al', name:'alfred'} ; nodes.push( aa,al ); links.push( {source: aa , target: al },{source: aa , target: ai },{source: ai , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '4. Auftritt';
}, 15000);
...
setTimeout(function() { console.log('load6'); var  aa = nodes[0],al = nodes[1],am = nodes[2] ; /* nodes.push(); */ links.push( {source: al , target: am },{source: aa , target: am },{source: aa , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '6. Auftritt';
}, 25000);
