...
setTimeout(function() { console.log('load4'); var  ad = nodes[2],ae = {id: 'ae', name:'gründling'} ; nodes.push( ae ); links.push( {source: ad , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
}, 15000);
...
setTimeout(function() { console.log('load21'); var  ad = nodes[0],al = nodes[4],aq = {id: 'aq', name:'bettler'},av = {id: 'av', name:'juwelier'} ; nodes.push( aq,av ); links.push( {source: al , target: av },{source: al , target: aq },{source: aq , target: av },{source: ad , target: al },{source: ad , target: av },{source: ad , target: aq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
}, 100000);
...
setTimeout(function() { console.log('load38'); var  ag = {id: 'ag', name:'valentin'},al = nodes[1] ; nodes.push( ag ); links.push( {source: ag , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
}, 185000);
