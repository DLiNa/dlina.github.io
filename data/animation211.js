...
setTimeout(function() { console.log('load3'); var  ab = {id: 'ab', name:'lisette'},ac = nodes[0],ae = {id: 'ae', name:'leonore'} ; nodes.push( ab,ae ); links.push( {source: ac , target: ae },{source: ab , target: ac },{source: ab , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt.';
}, 10000);
...
setTimeout(function() { console.log('load11'); var  aa = {id: 'aa', name:'verwalter'},ab = {id: 'ab', name:'lisette'},ac = nodes[0],ac = nodes[0],ad = nodes[1],ae = nodes[2],ag = nodes[3] ; nodes.push( aa,ab,ac ); links.push( {source: aa , target: ac },{source: aa , target: ae },{source: aa , target: ag },{source: aa , target: ab },{source: aa , target: ad },{source: aa , target: ac },{source: ac , target: ae },{source: ac , target: ag },{source: ac , target: ad },{source: ae , target: ag },{source: ab , target: ac },{source: ab , target: ae },{source: ab , target: ag },{source: ab , target: ad },{source: ab , target: ac },{source: ad , target: ae },{source: ad , target: ag },{source: ac , target: ae },{source: ac , target: ag },{source: ac , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Eilfter Auftritt.';
}, 50000);

setTimeout(function() { console.log('remv11'); var rm = [ 'aa','ae','ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 53750);

setTimeout(function() { console.log('load12'); var  ac = nodes[0],ac = nodes[0],ad = nodes[1],ag = nodes[2],ah = {id: 'ah', name:'maor'},ai = {id: 'ai', name:'blumenkranz'} ; nodes.push( ah,ai ); links.push( {source: ac , target: ai },{source: ac , target: ag },{source: ac , target: ah },{source: ac , target: ad },{source: ac , target: ai },{source: ac , target: ag },{source: ac , target: ah },{source: ac , target: ad },{source: ag , target: ai },{source: ag , target: ah },{source: ah , target: ai },{source: ad , target: ai },{source: ad , target: ag },{source: ad , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfter Auftritt.';
}, 55000);
...
setTimeout(function() { console.log('load19'); var  aj = nodes[0],ak = {id: 'ak', name:'notarias'} ; nodes.push( ak ); links.push( {source: aj , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt.';
}, 90000);
...
setTimeout(function() { console.log('load21'); var  ac = {id: 'ac', name:'baronnin'},ad = nodes[0],ae = {id: 'ae', name:'leonore'},ag = {id: 'ag', name:'baryon'},ag = {id: 'ag', name:'baryon'},ah = {id: 'ah', name:'maor'},ai = nodes[2] ; nodes.push( ac,ae,ag,ah ); links.push( {source: ac , target: ai },{source: ac , target: ag },{source: ac , target: ah },{source: ac , target: ad },{source: ac , target: ae },{source: ac , target: ag },{source: ag , target: ai },{source: ag , target: ah },{source: ah , target: ai },{source: ad , target: ai },{source: ad , target: ag },{source: ad , target: ah },{source: ad , target: ae },{source: ad , target: ag },{source: ae , target: ai },{source: ae , target: ag },{source: ae , target: ah },{source: ae , target: ag },{source: ag , target: ai },{source: ag , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt.';
}, 100000);

setTimeout(function() { console.log('remv21'); var rm = [ 'ac','ai','ad','ae' ]; rmNodes(rm); rmLinks(rm); start(); }, 103750);

setTimeout(function() { console.log('load22'); var  ag = nodes[0],ah = nodes[1],ah = nodes[1] ; /* nodes.push(); */ links.push( {source: ag , target: ah },{source: ag , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt.';
}, 105000);
