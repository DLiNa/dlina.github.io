...
setTimeout(function() { console.log('load10'); var  ab = nodes[0],af = {id: 'af', name:'paddermann'} ; nodes.push( af ); links.push( {source: ab , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '10. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnte Scene.';
}, 45000);
...
setTimeout(function() { console.log('load19'); var  aa = nodes[0],ab = nodes[1],af = {id: 'af', name:'paddermann'},af = {id: 'af', name:'paddermann'} ; nodes.push( af ); links.push( {source: ab , target: af },{source: ab , target: af },{source: aa , target: af },{source: aa , target: ab },{source: aa , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '19. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunzehnte Scene.';
}, 90000);
