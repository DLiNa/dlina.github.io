...
setTimeout(function() { console.log('load22'); var  ag = nodes[0],ak = {id: 'ak', name:'mutter'},al = {id: 'al', name:'hortensia'},an = {id: 'an', name:'baptist'},ar = nodes[1],ar = nodes[1],ar = nodes[1],ar = nodes[1],av = {id: 'av', name:'marie'} ; nodes.push( ak,al,an,ar,av ); links.push( {source: ak , target: av },{source: ak , target: ar },{source: ak , target: ar },{source: ak , target: ar },{source: ak , target: ar },{source: ak , target: an },{source: ak , target: al },{source: ag , target: av },{source: ag , target: ak },{source: ag , target: ar },{source: ag , target: ar },{source: ag , target: ar },{source: ag , target: ar },{source: ag , target: an },{source: ag , target: al },{source: ar , target: av },{source: ar , target: av },{source: ar , target: av },{source: ar , target: av },{source: an , target: av },{source: an , target: ar },{source: an , target: ar },{source: an , target: ar },{source: an , target: ar },{source: al , target: av },{source: al , target: ar },{source: al , target: ar },{source: al , target: ar },{source: al , target: ar },{source: al , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt';
}, 105000);
