setTimeout(function() { console.log('load1'); var  aa = {id: 'aa', name:'hugo'},ab = {id: 'ab', name:'elsabe'},ac = {id: 'ac', name:'willem_wütend'},ad = {id: 'ad', name:'mudder'},ae = {id: 'ae', name:'lisbeth'} ; nodes.push( aa,ab,ac,ad,ae ); links.push( {source: aa , target: ab },{source: aa , target: ac },{source: aa , target: ad },{source: aa , target: ae },{source: ab , target: ac },{source: ab , target: ad },{source: ab , target: ae },{source: ac , target: ad },{source: ac , target: ae },{source: ad , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '1. Akt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Akt.';
}, 0);
...
setTimeout(function() { console.log('load5'); var  aa = nodes[0],ab = nodes[1],ac = nodes[2],ac = nodes[2],ad = {id: 'ad', name:'mudder'} ; nodes.push( ac,ad ); links.push( {source: ab , target: ad },{source: ab , target: ac },{source: ab , target: ac },{source: ac , target: ad },{source: aa , target: ad },{source: aa , target: ab },{source: aa , target: ac },{source: aa , target: ac },{source: ac , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '5. Akt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Akt.';
}, 20000);
