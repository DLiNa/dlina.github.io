...
setTimeout(function() { console.log('load10'); var  ab = {id: 'ab', name:'die_witwe'},ac = nodes[1],ad = {id: 'ad', name:'leander'},ae = {id: 'ae', name:'oronte'} ; nodes.push( ab,ad,ae ); links.push( {source: ab , target: ad },{source: ab , target: ae },{source: ab , target: ac },{source: ad , target: ae },{source: ac , target: ad },{source: ac , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Letzter Auftritt';
}, 45000);
