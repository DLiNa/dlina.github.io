...
setTimeout(function() { console.log('load30'); var  ab = {id: 'ab', name:'melitta'},ad = nodes[0],af = {id: 'af', name:'phaon'},aj = nodes[1],aj = nodes[1] ; nodes.push( ab,af,aj ); links.push( {source: af , target: aj },{source: af , target: aj },{source: ab , target: af },{source: ab , target: aj },{source: ab , target: aj },{source: ab , target: ad },{source: ad , target: af },{source: ad , target: aj },{source: ad , target: aj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
}, 145000);
