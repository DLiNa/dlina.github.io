...
setTimeout(function() { console.log('load23'); var  ao = nodes[0],aw = {id: 'aw', name:'tränte'},aw = {id: 'aw', name:'tränte'} ; nodes.push( aw ); links.push( {source: ao , target: aw },{source: ao , target: aw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 110000);
...
setTimeout(function() { console.log('load27'); var  ac = {id: 'ac', name:'von_grobitzsch'},ae = nodes[0],ag = nodes[1],ah = {id: 'ah', name:'fritz'},ah = {id: 'ah', name:'fritz'},ak = nodes[3],al = nodes[4],am = nodes[5] ; nodes.push( ac,ah ); links.push( {source: ae , target: ak },{source: ae , target: al },{source: ae , target: ah },{source: ae , target: ag },{source: ae , target: ah },{source: ae , target: am },{source: ak , target: al },{source: ak , target: am },{source: al , target: am },{source: ah , target: ak },{source: ah , target: al },{source: ah , target: am },{source: ag , target: ak },{source: ag , target: al },{source: ag , target: ah },{source: ag , target: ah },{source: ag , target: am },{source: ah , target: ak },{source: ah , target: al },{source: ah , target: am },{source: ac , target: ae },{source: ac , target: ak },{source: ac , target: al },{source: ac , target: ah },{source: ac , target: ag },{source: ac , target: ah },{source: ac , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene';
}, 130000);

setTimeout(function() { console.log('remv27'); var rm = [ 'ah','ac' ]; rmNodes(rm); rmLinks(rm); start(); }, 133750);

setTimeout(function() { console.log('load28'); var  ae = nodes[0],ag = nodes[1],ak = nodes[3],al = nodes[4],am = nodes[5] ; /* nodes.push(); */ links.push( {source: ae , target: am },{source: ae , target: al },{source: ae , target: ag },{source: ae , target: ak },{source: al , target: am },{source: ag , target: am },{source: ag , target: al },{source: ag , target: ak },{source: ak , target: am },{source: ak , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 135000);
