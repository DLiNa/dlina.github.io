...
setTimeout(function() { console.log('load2'); var  ab = nodes[0],ac = nodes[1],ad = nodes[2],ad = nodes[2],ae = {id: 'ae', name:'chor'} ; nodes.push( ae ); links.push( {source: ad , target: ae },{source: ac , target: ad },{source: ac , target: ad },{source: ac , target: ae },{source: ad , target: ae },{source: ab , target: ad },{source: ab , target: ac },{source: ab , target: ad },{source: ab , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
}, 5000);
