...
setTimeout(function() { console.log('load7'); var  aq = nodes[0],as = {id: 'as', name:'wallrod'},at = {id: 'at', name:'steffen'} ; nodes.push( as,at ); links.push( {source: aq , target: as },{source: aq , target: at },{source: as , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Scene.';
}, 30000);
...
setTimeout(function() { console.log('load47'); var  am = nodes[0],ap = {id: 'ap', name:'mathilde'},as = {id: 'as', name:'wallrod'},bw = nodes[1],by = {id: 'by', name:'doctor'},bz = {id: 'bz', name:'franciskaner'} ; nodes.push( ap,as,by,bz ); links.push( {source: by , target: bz },{source: ap , target: by },{source: ap , target: bz },{source: ap , target: bw },{source: ap , target: as },{source: am , target: by },{source: am , target: bz },{source: am , target: ap },{source: am , target: bw },{source: am , target: as },{source: bw , target: by },{source: bw , target: bz },{source: as , target: by },{source: as , target: bz },{source: as , target: bw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Scene.';
}, 230000);
...
setTimeout(function() { console.log('load50'); var  aa = nodes[0],ae = {id: 'ae', name:'ulrich'},am = {id: 'am', name:'golo'},bv = nodes[1],cb = {id: 'cb', name:'oberjäger'} ; nodes.push( ae,am,cb ); links.push( {source: bv , target: cb },{source: am , target: bv },{source: am , target: cb },{source: aa , target: bv },{source: aa , target: cb },{source: aa , target: am },{source: aa , target: ae },{source: ae , target: bv },{source: ae , target: cb },{source: ae , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnte Scene.';
}, 245000);
...
setTimeout(function() { console.log('load52'); var  aa = nodes[0],ae = nodes[1],am = nodes[2] ; /* nodes.push(); */ links.push( {source: ae , target: am },{source: aa , target: am },{source: aa , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfte Scene.';
}, 255000);
