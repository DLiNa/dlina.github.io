...
setTimeout(function() { console.log('load15'); var  aa = nodes[0],am = {id: 'am', name:'gundelfing'} ; nodes.push( am ); links.push( {source: aa , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt.';
}, 70000);

setTimeout(function() { console.log('remv15'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 73750);

setTimeout(function() { console.log('load16'); var  aa = nodes[0],am = nodes[1],au = {id: 'au', name:'thorringer'} ; nodes.push( au ); links.push( {source: aa , target: au },{source: aa , target: am },{source: am , target: au } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt.';
}, 75000);

setTimeout(function() { console.log('remv16'); var rm = [ 'aa','au','am' ]; rmNodes(rm); rmLinks(rm); start(); }, 78750);

setTimeout(function() { console.log('load17'); var  ag = {id: 'ag', name:'ernst'},ai = {id: 'ai', name:'tuchsenhauser'},aj = {id: 'aj', name:'pienzenauer'},al = {id: 'al', name:'maxelrainer'},an = {id: 'an', name:'seibelstorfer'},ao = {id: 'ao', name:'vicedom'} ; nodes.push( ag,ai,aj,al,an,ao ); links.push( {source: ag , target: ao },{source: ag , target: ai },{source: ag , target: aj },{source: ag , target: an },{source: ag , target: al },{source: ai , target: ao },{source: ai , target: aj },{source: ai , target: an },{source: ai , target: al },{source: aj , target: ao },{source: aj , target: an },{source: aj , target: al },{source: an , target: ao },{source: al , target: ao },{source: al , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt.';
}, 80000);

setTimeout(function() { console.log('remv17'); var rm = [ 'ag','ao','aj','an','al' ]; rmNodes(rm); rmLinks(rm); start(); }, 83750);

setTimeout(function() { console.log('load18'); var  aa = {id: 'aa', name:'albrecht'},ai = nodes[1],ak = {id: 'ak', name:'tore'} ; nodes.push( aa,ak ); links.push( {source: aa , target: ai },{source: aa , target: ak },{source: ai , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt.';
}, 85000);

setTimeout(function() { console.log('remv18'); var rm = [ 'aa' ]; rmNodes(rm); rmLinks(rm); start(); }, 88750);

setTimeout(function() { console.log('load19'); var  ai = nodes[1],ak = nodes[2] ; /* nodes.push(); */ links.push( {source: ai , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt.';
}, 90000);

setTimeout(function() { console.log('remv19'); var rm = [ 'ai','ak' ]; rmNodes(rm); rmLinks(rm); start(); }, 93750);

setTimeout(function() { console.log('load20'); var  aa = {id: 'aa', name:'albrecht'},ab = {id: 'ab', name:'zenger'},ab = {id: 'ab', name:'zenger'},ac = {id: 'ac', name:'percifal_zenger'},ad = {id: 'ad', name:'agnes'} ; nodes.push( aa,ab,ac,ad ); links.push( {source: ac , target: ad },{source: ab , target: ac },{source: ab , target: ad },{source: aa , target: ac },{source: aa , target: ad },{source: aa , target: ab },{source: aa , target: ab },{source: ab , target: ac },{source: ab , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt.';
}, 95000);
