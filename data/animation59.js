setTimeout(function() { console.log('load1'); var  aa = {id: 'aa', name:'prinzessin_trull'},ab = {id: 'ab', name:'die_alte_raschke'},ac = {id: 'ac', name:'rapunzel'} ; nodes.push( aa,ab,ac ); links.push( {source: aa , target: ab },{source: aa , target: ac },{source: ab , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene.';
}, 0);

setTimeout(function() { console.log('remv1'); var rm = [ 'aa','ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 3750);

setTimeout(function() { console.log('load2'); var  ac = nodes[2],ad = {id: 'ad', name:'christel'} ; nodes.push( ad ); links.push( {source: ac , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene.';
}, 5000);

setTimeout(function() { console.log('remv2'); var rm = [ 'ac','ad' ]; rmNodes(rm); rmLinks(rm); start(); }, 8750);

setTimeout(function() { console.log('load3'); var  ab = {id: 'ab', name:'die_alte_raschke'},ae = {id: 'ae', name:'der_alte_raschke'},af = {id: 'af', name:'die_junge_raschke'} ; nodes.push( ab,ae,af ); links.push( {source: ab , target: ae },{source: ab , target: af },{source: ae , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene.';
}, 10000);

setTimeout(function() { console.log('remv3'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 13750);

setTimeout(function() { console.log('load4'); var  ab = nodes[0],ae = nodes[1],af = nodes[2] ; /* nodes.push(); */ links.push( {source: ae , target: af },{source: ab , target: ae },{source: ab , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Szene.';
}, 15000);

setTimeout(function() { console.log('remv4'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 18750);

setTimeout(function() { console.log('load5'); var  ab = nodes[0],ae = nodes[1],af = nodes[2],ag = {id: 'ag', name:'der_gendarm'} ; nodes.push( ag ); links.push( {source: ab , target: ag },{source: ab , target: af },{source: ab , target: ae },{source: af , target: ag },{source: ae , target: ag },{source: ae , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Szene.';
}, 20000);

setTimeout(function() { console.log('remv5'); var rm = [ 'ag','ab','af' ]; rmNodes(rm); rmLinks(rm); start(); }, 23750);

setTimeout(function() { console.log('load6'); var  ae = nodes[1],ah = {id: 'ah', name:'hermann_raschke'} ; nodes.push( ah ); links.push( {source: ae , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechste Szene.';
}, 25000);

setTimeout(function() { console.log('remv6'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 28750);

setTimeout(function() { console.log('load7'); var  ae = nodes[0],af = {id: 'af', name:'die_junge_raschke'},ag = {id: 'ag', name:'der_gendarm'},ah = nodes[1] ; nodes.push( af,ag ); links.push( {source: ae , target: ag },{source: ae , target: af },{source: ae , target: ah },{source: ag , target: ah },{source: af , target: ag },{source: af , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Szene.';
}, 30000);

setTimeout(function() { console.log('remv7'); var rm = [ 'ag' ]; rmNodes(rm); rmLinks(rm); start(); }, 33750);

setTimeout(function() { console.log('load8'); var  ab = {id: 'ab', name:'die_alte_raschke'},ae = nodes[0],af = nodes[1],ah = nodes[3] ; nodes.push( ab ); links.push( {source: ae , target: af },{source: ae , target: ah },{source: af , target: ah },{source: ab , target: ae },{source: ab , target: af },{source: ab , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Achte Szene.';
}, 35000);

setTimeout(function() { console.log('remv8'); var rm = [ 'af','ah','ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 38750);

setTimeout(function() { console.log('load9'); var  aa = {id: 'aa', name:'prinzessin_trull'},ae = nodes[1] ; nodes.push( aa ); links.push( {source: aa , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunte Szene.';
}, 40000);
...
setTimeout(function() { console.log('load11'); var  ag = {id: 'ag', name:'der_gendarm'},aq = {id: 'aq', name:'der_wirt'},ar = {id: 'ar', name:'die_wirtin'} ; nodes.push( ag,aq,ar ); links.push( {source: aq , target: ar },{source: ag , target: aq },{source: ag , target: ar } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene.';
}, 50000);

setTimeout(function() { console.log('remv11'); var rm = [ 'ar' ]; rmNodes(rm); rmLinks(rm); start(); }, 53750);

setTimeout(function() { console.log('load12'); var  ag = nodes[0],aq = nodes[1],as = {id: 'as', name:'der_fremde'},at = {id: 'at', name:'der_eine_diener'} ; nodes.push( as,at ); links.push( {source: aq , target: as },{source: aq , target: at },{source: as , target: at },{source: ag , target: aq },{source: ag , target: as },{source: ag , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene.';
}, 55000);

setTimeout(function() { console.log('remv12'); var rm = [ 'aq','at' ]; rmNodes(rm); rmLinks(rm); start(); }, 58750);

setTimeout(function() { console.log('load13'); var  ag = nodes[0],as = nodes[2],au = {id: 'au', name:'der_bauer'} ; nodes.push( au ); links.push( {source: as , target: au },{source: ag , target: as },{source: ag , target: au } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene.';
}, 60000);
...
setTimeout(function() { console.log('load16'); var  aq = nodes[2],ar = nodes[3],au = {id: 'au', name:'der_bauer'},av = {id: 'av', name:'einer_der_bauern'},ay = nodes[6],az = {id: 'az', name:'ein_anderes_mädchen'} ; nodes.push( au,av,az ); links.push( {source: av , target: ay },{source: av , target: az },{source: ay , target: az },{source: au , target: av },{source: au , target: ay },{source: au , target: az },{source: aq , target: av },{source: aq , target: ay },{source: aq , target: az },{source: aq , target: au },{source: aq , target: ar },{source: ar , target: av },{source: ar , target: ay },{source: ar , target: az },{source: ar , target: au } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechste Szene.';
}, 75000);

setTimeout(function() { console.log('remv16'); var rm = [ 'av','ay','az','aq','ar' ]; rmNodes(rm); rmLinks(rm); start(); }, 78750);

setTimeout(function() { console.log('load17'); var  ag = {id: 'ag', name:'der_gendarm'},as = {id: 'as', name:'der_fremde'},au = nodes[2],au = nodes[2],ba = {id: 'ba', name:'ein_bauernmädchen'} ; nodes.push( ag,as,ba ); links.push( {source: as , target: au },{source: as , target: au },{source: as , target: ba },{source: au , target: ba },{source: au , target: ba },{source: ag , target: as },{source: ag , target: au },{source: ag , target: au },{source: ag , target: ba } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Szene.';
}, 80000);
...
setTimeout(function() { console.log('load19'); var  an = {id: 'an', name:'der_amtssekretär'},bc = {id: 'bc', name:'der_polizist'} ; nodes.push( an,bc ); links.push( {source: an , target: bc } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene.';
}, 90000);

setTimeout(function() { console.log('remv19'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 93750);

setTimeout(function() { console.log('load20'); var  ae = {id: 'ae', name:'der_alte_raschke'},ag = {id: 'ag', name:'der_gendarm'},an = nodes[0],bc = nodes[1] ; nodes.push( ae,ag ); links.push( {source: ae , target: an },{source: ae , target: bc },{source: ae , target: ag },{source: an , target: bc },{source: ag , target: an },{source: ag , target: bc } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene.';
}, 95000);

setTimeout(function() { console.log('remv20'); var rm = [ 'bc','ag' ]; rmNodes(rm); rmLinks(rm); start(); }, 98750);

setTimeout(function() { console.log('load21'); var  ae = nodes[0],ah = {id: 'ah', name:'hermann_raschke'},an = nodes[2] ; nodes.push( ah ); links.push( {source: ah , target: an },{source: ae , target: ah },{source: ae , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene.';
}, 100000);

setTimeout(function() { console.log('remv21'); var rm = [ 'ah' ]; rmNodes(rm); rmLinks(rm); start(); }, 103750);

setTimeout(function() { console.log('load22'); var  ab = {id: 'ab', name:'die_alte_raschke'},ae = nodes[0],af = {id: 'af', name:'die_junge_raschke'},an = nodes[2] ; nodes.push( ab,af ); links.push( {source: ab , target: af },{source: ab , target: an },{source: ab , target: ae },{source: af , target: an },{source: ae , target: af },{source: ae , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Szene.';
}, 105000);

setTimeout(function() { console.log('remv22'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 108750);

setTimeout(function() { console.log('load23'); var  ab = nodes[0],ac = {id: 'ac', name:'rapunzel'},ae = nodes[1],af = nodes[2],ag = {id: 'ag', name:'der_gendarm'},an = nodes[3] ; nodes.push( ac,ag ); links.push( {source: ag , target: an },{source: ac , target: an },{source: ac , target: ag },{source: ac , target: ae },{source: ac , target: af },{source: ae , target: an },{source: ae , target: ag },{source: ae , target: af },{source: af , target: an },{source: af , target: ag },{source: ab , target: an },{source: ab , target: ag },{source: ab , target: ac },{source: ab , target: ae },{source: ab , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Szene.';
}, 110000);

setTimeout(function() { console.log('remv23'); var rm = [ 'ag','ac','ae','af','ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 113750);

setTimeout(function() { console.log('load24'); var  an = nodes[5],bd = {id: 'bd', name:'der_diener'} ; nodes.push( bd ); links.push( {source: an , target: bd } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechste Szene.';
}, 115000);

setTimeout(function() { console.log('remv24'); var rm = [ 'bd' ]; rmNodes(rm); rmLinks(rm); start(); }, 118750);

setTimeout(function() { console.log('load25'); var  an = nodes[0],bc = {id: 'bc', name:'der_polizist'} ; nodes.push( bc ); links.push( {source: an , target: bc } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Szene.';
}, 120000);

setTimeout(function() { console.log('remv25'); var rm = [ 'an','bc' ]; rmNodes(rm); rmLinks(rm); start(); }, 123750);

setTimeout(function() { console.log('load26'); var  aa = {id: 'aa', name:'prinzessin_trull'} ; nodes.push( aa ); links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene.';
}, 125000);

setTimeout(function() { console.log('remv26'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 128750);

setTimeout(function() { console.log('load27'); var  aa = nodes[0],be = {id: 'be', name:'die_stimme'},be = {id: 'be', name:'die_stimme'} ; nodes.push( be ); links.push( {source: aa , target: be },{source: aa , target: be } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene.';
}, 130000);

setTimeout(function() { console.log('remv27'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 133750);

setTimeout(function() { console.log('load28'); var  aa = nodes[0],ac = {id: 'ac', name:'rapunzel'},be = nodes[1] ; nodes.push( ac ); links.push( {source: ac , target: be },{source: aa , target: ac },{source: aa , target: be } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene.';
}, 135000);
...
setTimeout(function() { console.log('load30'); var  ab = nodes[1],af = {id: 'af', name:'die_junge_raschke'},ah = {id: 'ah', name:'hermann_raschke'},be = nodes[3] ; nodes.push( af,ah ); links.push( {source: af , target: ah },{source: af , target: be },{source: ah , target: be },{source: ab , target: af },{source: ab , target: ah },{source: ab , target: be } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Szene.';
}, 145000);

setTimeout(function() { console.log('remv30'); var rm = [ 'af','ah','ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 148750);

setTimeout(function() { console.log('load31'); var  ae = {id: 'ae', name:'der_alte_raschke'},be = nodes[3] ; nodes.push( ae ); links.push( {source: ae , target: be } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechste Szene.';
}, 150000);
