...
setTimeout(function() { console.log('load4'); var  aa = nodes[0],ac = nodes[2],af = {id: 'af', name:'sonnenberg'} ; nodes.push( af ); links.push( {source: aa , target: af },{source: aa , target: ac },{source: ac , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Scene';
}, 15000);
...
setTimeout(function() { console.log('load24'); var  af = nodes[1],am = nodes[2],ba = {id: 'ba', name:'ritter'},ba = {id: 'ba', name:'ritter'} ; nodes.push( ba ); links.push( {source: am , target: ba },{source: am , target: ba },{source: af , target: ba },{source: af , target: am },{source: af , target: ba } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechste Scene';
}, 115000);
