...
setTimeout(function() { console.log('load37'); var  ac = nodes[0],ae = nodes[1],af = {id: 'af', name:'sonnenberg'},aw = nodes[2],az = nodes[3] ; nodes.push( ac,af ); links.push( {source: aw , target: az },{source: af , target: aw },{source: af , target: az },{source: ac , target: aw },{source: ac , target: az },{source: ac , target: af },{source: ac , target: ae },{source: ae , target: aw },{source: ae , target: az },{source: ae , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Letzte Scene';
}, 180000);
