...
setTimeout(function() { console.log('load7'); var  ae = nodes[0],ae = nodes[0],ag = nodes[1],ak = {id: 'ak', name:'marie'} ; nodes.push( ak ); links.push( {source: ag , target: ak },{source: ae , target: ag },{source: ae , target: ak },{source: ae , target: ag },{source: ae , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Szene';
}, 30000);
