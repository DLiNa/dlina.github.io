...
setTimeout(function() { console.log('load10'); var  aa = nodes[0],ab = nodes[1],ac = {id: 'ac', name:'suschen'},ad = {id: 'ad', name:'beringer'},ae = {id: 'ae', name:'bürgermeiester'},ae = {id: 'ae', name:'bürgermeiester'},af = {id: 'af', name:'stelzer'},ag = nodes[3],ak = {id: 'ak', name:'marie'} ; nodes.push( ac,ad,ae,af,ak ); links.push( {source: ae , target: ag },{source: ae , target: ak },{source: ae , target: af },{source: ad , target: ae },{source: ad , target: ag },{source: ad , target: ae },{source: ad , target: ak },{source: ad , target: af },{source: ag , target: ak },{source: ae , target: ag },{source: ae , target: ak },{source: ae , target: af },{source: ac , target: ae },{source: ac , target: ad },{source: ac , target: ag },{source: ac , target: ae },{source: ac , target: ak },{source: ac , target: af },{source: ab , target: ae },{source: ab , target: ad },{source: ab , target: ag },{source: ab , target: ae },{source: ab , target: ac },{source: ab , target: ak },{source: ab , target: af },{source: aa , target: ae },{source: aa , target: ad },{source: aa , target: ag },{source: aa , target: ae },{source: aa , target: ac },{source: aa , target: ab },{source: aa , target: ak },{source: aa , target: af },{source: af , target: ag },{source: af , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnte Szene';
}, 45000);

setTimeout(function() { console.log('remv10'); var rm = [ 'ad','ag','ac','aa','ak','af' ]; rmNodes(rm); rmLinks(rm); start(); }, 48750);

setTimeout(function() { console.log('load11'); var  ab = nodes[0],ae = nodes[1],al = {id: 'al', name:'hartl'} ; nodes.push( al ); links.push( {source: ae , target: al },{source: ab , target: al },{source: ab , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 50000);
...
setTimeout(function() { console.log('load14'); var  ab = nodes[0],ae = nodes[1] ; /* nodes.push(); */ links.push( {source: ab , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Szene';
}, 65000);

setTimeout(function() { console.log('remv14'); var rm = [ 'ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 68750);

setTimeout(function() { console.log('load15'); var  ad = {id: 'ad', name:'beringer'},ae = nodes[0] ; nodes.push( ad ); links.push( {source: ad , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Szene';
}, 70000);
...
setTimeout(function() { console.log('load17'); var  ab = nodes[0],ae = nodes[1],am = {id: 'am', name:'frieda'} ; nodes.push( am ); links.push( {source: ae , target: am },{source: ab , target: am },{source: ab , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Szene';
}, 80000);
...
setTimeout(function() { console.log('load21'); var  ad = nodes[0],ae = nodes[1] ; /* nodes.push(); */ links.push( {source: ad , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfte Szene';
}, 100000);
...
setTimeout(function() { console.log('load38'); var  ab = {id: 'ab', name:'frau_bügermeister'},ac = {id: 'ac', name:'suschen'},ad = {id: 'ad', name:'beringer'},ae = nodes[0],af = {id: 'af', name:'stelzer'},ag = nodes[1],ak = {id: 'ak', name:'marie'} ; nodes.push( ab,ac,ad,af,ak ); links.push( {source: ag , target: ak },{source: ae , target: ag },{source: ae , target: ak },{source: ae , target: af },{source: ac , target: ag },{source: ac , target: ae },{source: ac , target: ad },{source: ac , target: ak },{source: ac , target: af },{source: ad , target: ag },{source: ad , target: ae },{source: ad , target: ak },{source: ad , target: af },{source: ab , target: ag },{source: ab , target: ae },{source: ab , target: ac },{source: ab , target: ad },{source: ab , target: ak },{source: ab , target: af },{source: af , target: ag },{source: af , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfte Szene';
}, 185000);
