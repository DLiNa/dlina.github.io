...
setTimeout(function() { console.log('load4');nodes.sort(compare); /* af ag ah */ var  af = nodes[0] ,ag = {id: 'ag', name:'zänker'},ah = nodes[1]  ; nodes.push( ag ); links.push( {source: ag , target: ah },{source: af , target: ag },{source: af , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 15000);
...
setTimeout(function() { console.log('load5');nodes.sort(compare); /* af ag */ var  af = nodes[0] ,ag = nodes[1]  ; /* nodes.push(); */ links.push( {source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 20000);
...
setTimeout(function() { console.log('load6');nodes.sort(compare); /* ae ah */ var  ae = {id: 'ae', name:'fähnlein'},ah = {id: 'ah', name:'hammer'} ; nodes.push( ae,ah ); links.push( {source: ae , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechste Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 25000);
...
setTimeout(function() { console.log('load12');nodes.sort(compare); /* aq aw */ var  aq = nodes[0] ,aw = nodes[1]  ; /* nodes.push(); */ links.push( {source: aq , target: aw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 55000);
...
setTimeout(function() { console.log('load16');nodes.sort(compare); /* ah aw */ var  ah = nodes[0] ,aw = {id: 'aw', name:'thomas'} ; nodes.push( aw ); links.push( {source: ah , target: aw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Szene'; var act = document.getElementById('act');act.innerHTML = 'noName'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 75000);
...
setTimeout(function() { console.log('load17');nodes.sort(compare); /* az ba */ var  az = {id: 'az', name:'florian'},ba = {id: 'ba', name:'alte_hammer'} ; nodes.push( az,ba ); links.push( {source: az , target: ba } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 80000);
...
setTimeout(function() { console.log('load19');nodes.sort(compare); /* aq ba */ var  aq = nodes[0] ,ba = {id: 'ba', name:'alte_hammer'} ; nodes.push( ba ); links.push( {source: aq , target: ba } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 90000);
...
setTimeout(function() { console.log('load21');nodes.sort(compare); /* ah aq aw az ba */ var  ah = {id: 'ah', name:'hammer'},aq = {id: 'aq', name:'frau_xandl'},aw = {id: 'aw', name:'thomas'},az = nodes[0] ,ba = nodes[1]  ; nodes.push( ah,aq,aw ); links.push( {source: aw , target: ba },{source: aw , target: az },{source: aq , target: aw },{source: aq , target: ba },{source: aq , target: az },{source: ah , target: aw },{source: ah , target: ba },{source: ah , target: aq },{source: ah , target: az },{source: az , target: ba } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 100000);
...
setTimeout(function() { console.log('load22');nodes.sort(compare); /* aq aw ba */ var  aq = nodes[0] ,aw = nodes[1] ,ba = nodes[2]  ; /* nodes.push(); */ links.push( {source: aw , target: ba },{source: aq , target: ba },{source: aq , target: aw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Achte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 105000);
...
setTimeout(function() { console.log('load23');nodes.sort(compare); /* ah aw ba */ var  ah = {id: 'ah', name:'hammer'},aw = nodes[0] ,ba = nodes[1]  ; nodes.push( ah ); links.push( {source: aw , target: ba },{source: ah , target: aw },{source: ah , target: ba } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 110000);
...
setTimeout(function() { console.log('load24');nodes.sort(compare); /* ah aw */ var  ah = nodes[0] ,aw = nodes[1]  ; /* nodes.push(); */ links.push( {source: ah , target: aw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 115000);
...
setTimeout(function() { console.log('load25');nodes.sort(compare); /* ah ba */ var  ah = nodes[0] ,ba = {id: 'ba', name:'alte_hammer'} ; nodes.push( ba ); links.push( {source: ah , target: ba } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 120000);
...
setTimeout(function() { console.log('load27');nodes.sort(compare); /* ad ae af ai */ var  ad = {id: 'ad', name:'schraube'},ae = {id: 'ae', name:'fähnlein'},af = nodes[0] ,ai = nodes[1]  ; nodes.push( ad,ae ); links.push( {source: af , target: ai },{source: ad , target: af },{source: ad , target: ai },{source: ad , target: ae },{source: ae , target: af },{source: ae , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 130000);
...
setTimeout(function() { console.log('load28');nodes.sort(compare); /* ad af ai */ var  ad = nodes[0] ,af = nodes[1] ,ai = nodes[2]  ; /* nodes.push(); */ links.push( {source: ad , target: ai },{source: ad , target: af },{source: ad , target: ai },{source: ad , target: af },{source: af , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 135000);
...
setTimeout(function() { console.log('load29');nodes.sort(compare); /* ad af ai aw */ var  ad = nodes[0] ,af = nodes[1] ,ai = nodes[2] ,aw = {id: 'aw', name:'thomas'} ; nodes.push( aw ); links.push( {source: ai , target: aw },{source: af , target: aw },{source: af , target: ai },{source: ad , target: aw },{source: ad , target: ai },{source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 140000);
...
setTimeout(function() { console.log('load30');nodes.sort(compare); /* ad aw */ var  ad = nodes[0] ,aw = nodes[1]  ; /* nodes.push(); */ links.push( {source: ad , target: aw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 145000);
...
setTimeout(function() { console.log('load32');nodes.sort(compare); /* ad af ai aw */ var  ad = nodes[0] ,af = {id: 'af', name:'hermine'},ai = nodes[1] ,aw = nodes[2]  ; nodes.push( af ); links.push( {source: af , target: aw },{source: af , target: ai },{source: ai , target: aw },{source: ad , target: af },{source: ad , target: aw },{source: ad , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '7. Szene'; var act = document.getElementById('act');act.innerHTML = 'noName'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 155000);
...
setTimeout(function() { console.log('load33');nodes.sort(compare); /* ae ah az ba */ var  ae = {id: 'ae', name:'fähnlein'},ah = {id: 'ah', name:'hammer'},az = {id: 'az', name:'florian'},ba = {id: 'ba', name:'alte_hammer'} ; nodes.push( ae,ah,az,ba ); links.push( {source: ah , target: ba },{source: ah , target: az },{source: ae , target: ah },{source: ae , target: ba },{source: ae , target: az },{source: az , target: ba } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Achte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 160000);
...
setTimeout(function() { console.log('load34');nodes.sort(compare); /* ad ae ah aw az ba */ var  ad = {id: 'ad', name:'schraube'},ae = nodes[0] ,ah = nodes[1] ,aw = {id: 'aw', name:'thomas'},az = nodes[2] ,ba = nodes[3]  ; nodes.push( ad,aw ); links.push( {source: aw , target: ba },{source: aw , target: az },{source: az , target: ba },{source: ah , target: aw },{source: ah , target: ba },{source: ah , target: az },{source: ae , target: aw },{source: ae , target: ba },{source: ae , target: az },{source: ae , target: ah },{source: ad , target: aw },{source: ad , target: ba },{source: ad , target: az },{source: ad , target: ah },{source: ad , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunte Scene.';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '0%' ;
}, 165000);
