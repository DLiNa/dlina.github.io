...
setTimeout(function() { console.log('load10'); var  ag = nodes[0],ah = nodes[1],ai = nodes[3],aj = {id: 'aj', name:'zwei_gerichtsdiener'} ; nodes.push( aj ); links.push( {source: ai , target: aj },{source: ag , target: ai },{source: ag , target: aj },{source: ag , target: ah },{source: ah , target: ai },{source: ah , target: aj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt';
}, 45000);
...
setTimeout(function() { console.log('load26'); var  ah = nodes[1],bf = {id: 'bf', name:'olimar'},bg = {id: 'bg', name:'astrachan'} ; nodes.push( bf,bg ); links.push( {source: bf , target: bg },{source: ah , target: bf },{source: ah , target: bg } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
}, 125000);
...
setTimeout(function() { console.log('load30'); var  ag = nodes[0],ah = {id: 'ah', name:'simplicius'},bk = nodes[2] ; nodes.push( ah ); links.push( {source: ah , target: bk },{source: ag , target: ah },{source: ag , target: bk } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfter Auftritt';
}, 145000);
...
setTimeout(function() { console.log('load37'); var  aa = {id: 'aa', name:'phalarius'},ab = {id: 'ab', name:'hades'},ax = {id: 'ax', name:'antrokles'},br = {id: 'br', name:'die_drei_geister'},bs = nodes[2],bt = nodes[3],bu = nodes[4] ; nodes.push( aa,ab,ax,br ); links.push( {source: aa , target: ax },{source: aa , target: br },{source: aa , target: bs },{source: aa , target: bt },{source: aa , target: bu },{source: aa , target: ab },{source: ax , target: br },{source: ax , target: bs },{source: ax , target: bt },{source: ax , target: bu },{source: br , target: bs },{source: br , target: bt },{source: br , target: bu },{source: bs , target: bt },{source: bs , target: bu },{source: bt , target: bu },{source: ab , target: ax },{source: ab , target: br },{source: ab , target: bs },{source: ab , target: bt },{source: ab , target: bu } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '18. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achtzehnter Auftritt';
}, 180000);
