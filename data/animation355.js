setTimeout(function() { console.log('load1'); var  aa = {id: 'aa', name:'käthchen'} ; nodes.push( aa ); links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 0);
...
setTimeout(function() { console.log('load19'); var  ad = nodes[0],ag = {id: 'ag', name:'hans'} ; nodes.push( ag ); links.push( {source: ad , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Szene';
}, 90000);
...
setTimeout(function() { console.log('load26'); var  ad = nodes[0],af = {id: 'af', name:'müller'} ; nodes.push( af ); links.push( {source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfte Szene';
}, 125000);

setTimeout(function() { console.log('remv26'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 128750);

setTimeout(function() { console.log('load27'); var  ad = nodes[0],ae = {id: 'ae', name:'therese'},af = nodes[1] ; nodes.push( ae ); links.push( {source: ae , target: af },{source: ad , target: ae },{source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfte Szene';
}, 130000);
...
setTimeout(function() { console.log('load39'); var  aa = {id: 'aa', name:'käthchen'},ab = {id: 'ab', name:'karl'},ac = {id: 'ac', name:'redlich'},ad = nodes[0],ah = {id: 'ah', name:'toloysky'} ; nodes.push( aa,ab,ac,ah ); links.push( {source: ad , target: ah },{source: ab , target: ad },{source: ab , target: ac },{source: ab , target: ah },{source: ac , target: ad },{source: ac , target: ah },{source: aa , target: ad },{source: aa , target: ab },{source: aa , target: ac },{source: aa , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 190000);
...
setTimeout(function() { console.log('load41'); var  ad = nodes[3],af = nodes[4],ah = {id: 'ah', name:'toloysky'} ; nodes.push( ah ); links.push( {source: af , target: ah },{source: ad , target: af },{source: ad , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 200000);
...
setTimeout(function() { console.log('load49'); var  aa = {id: 'aa', name:'käthchen'},ab = {id: 'ab', name:'karl'},ac = nodes[0],ae = nodes[2] ; nodes.push( aa,ab ); links.push( {source: ac , target: ae },{source: ab , target: ac },{source: ab , target: ae },{source: aa , target: ac },{source: aa , target: ab },{source: aa , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfte Szene';
}, 240000);
