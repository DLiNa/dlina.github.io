...
setTimeout(function() { console.log('load11'); var  ak = nodes[0],al = {id: 'al', name:'knappe'} ; nodes.push( al ); links.push( {source: ak , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfte Scene.';
}, 50000);
...
setTimeout(function() { console.log('load21'); var  ah = nodes[0],ap = {id: 'ap', name:'eine_hexe'} ; nodes.push( ap ); links.push( {source: ah , target: ap } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Scene.';
}, 100000);
...
setTimeout(function() { console.log('load32'); var  aa = {id: 'aa', name:'faust'},ah = nodes[0],ak = nodes[1] ; nodes.push( aa ); links.push( {source: aa , target: ak },{source: aa , target: ah },{source: ah , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '13. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dreizehnte Scene.';
}, 155000);

setTimeout(function() { console.log('remv32'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 158750);

setTimeout(function() { console.log('load33'); var  aa = nodes[0],ab = {id: 'ab', name:'mephisto'},af = {id: 'af', name:'röschen'},ag = {id: 'ag', name:'franz'},ah = nodes[1],ah = nodes[1],ai = {id: 'ai', name:'kunigunde'},ak = nodes[2],at = {id: 'at', name:'chor_der_männer'} ; nodes.push( ab,af,ag,ah,ai,at ); links.push( {source: af , target: ai },{source: af , target: ak },{source: af , target: ag },{source: af , target: ah },{source: af , target: at },{source: af , target: ah },{source: aa , target: af },{source: aa , target: ai },{source: aa , target: ab },{source: aa , target: ak },{source: aa , target: ag },{source: aa , target: ah },{source: aa , target: at },{source: aa , target: ah },{source: ai , target: ak },{source: ai , target: at },{source: ab , target: af },{source: ab , target: ai },{source: ab , target: ak },{source: ab , target: ag },{source: ab , target: ah },{source: ab , target: at },{source: ab , target: ah },{source: ak , target: at },{source: ag , target: ai },{source: ag , target: ak },{source: ag , target: ah },{source: ag , target: at },{source: ag , target: ah },{source: ah , target: ai },{source: ah , target: ak },{source: ah , target: at },{source: ah , target: ai },{source: ah , target: ak },{source: ah , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '14. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierzehnte Scene.';
}, 160000);

setTimeout(function() { console.log('remv33'); var rm = [ 'af','aa','ai','ak','ag','ah','at' ]; rmNodes(rm); rmLinks(rm); start(); }, 163750);

setTimeout(function() { console.log('load34'); var  ab = nodes[0] ; /* nodes.push(); */ links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Scene.';
}, 165000);
...
setTimeout(function() { console.log('load40'); var  aa = {id: 'aa', name:'faust'},ab = nodes[0],ab = nodes[0],ac = {id: 'ac', name:'wagner'},af = nodes[1],ag = nodes[2],ai = nodes[3] ; nodes.push( aa,ab,ac ); links.push( {source: af , target: ai },{source: af , target: ag },{source: ag , target: ai },{source: ab , target: ai },{source: ab , target: af },{source: ab , target: ag },{source: ab , target: ac },{source: ac , target: ai },{source: ac , target: af },{source: ac , target: ag },{source: aa , target: ai },{source: aa , target: af },{source: aa , target: ag },{source: aa , target: ab },{source: aa , target: ac },{source: aa , target: ab },{source: ab , target: ai },{source: ab , target: af },{source: ab , target: ag },{source: ab , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Scene.';
}, 195000);

setTimeout(function() { console.log('remv40'); var rm = [ 'af','ag','ab','ac' ]; rmNodes(rm); rmLinks(rm); start(); }, 198750);

setTimeout(function() { console.log('load41'); var  aa = nodes[0],ai = nodes[2],au = {id: 'au', name:'wohlhaldt'} ; nodes.push( au ); links.push( {source: aa , target: au },{source: aa , target: ai },{source: ai , target: au } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Achte Scene.';
}, 200000);
...
setTimeout(function() { console.log('load43'); var  aa = nodes[0],ab = nodes[1],ab = nodes[1],ac = {id: 'ac', name:'wagner'},ad = nodes[2],ai = nodes[3],au = nodes[4] ; nodes.push( ab,ac ); links.push( {source: ac , target: au },{source: ac , target: ad },{source: ac , target: ai },{source: aa , target: ac },{source: aa , target: au },{source: aa , target: ad },{source: aa , target: ai },{source: aa , target: ab },{source: aa , target: ab },{source: ad , target: au },{source: ad , target: ai },{source: ai , target: au },{source: ab , target: ac },{source: ab , target: au },{source: ab , target: ad },{source: ab , target: ai },{source: ab , target: ac },{source: ab , target: au },{source: ab , target: ad },{source: ab , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnte Scene.';
}, 210000);
