setTimeout(function() { console.log('load1'); var  aa = {id: 'aa', name:'schön'},ab = {id: 'ab', name:'anna'} ; nodes.push( aa,ab ); links.push( {source: aa , target: ab } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 0);
...
setTimeout(function() { console.log('load7'); var  ae = nodes[2],af = nodes[3] ; /* nodes.push(); */ links.push( {source: ae , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Szene';
}, 30000);
...
setTimeout(function() { console.log('load38'); var  aa = nodes[0],ac = {id: 'ac', name:'hutterer'},ad = {id: 'ad', name:'sidonie'},af = {id: 'af', name:'herwig'},ag = {id: 'ag', name:'eduard'},ak = nodes[3] ; nodes.push( ac,ad,af,ag ); links.push( {source: ac , target: ak },{source: ac , target: ag },{source: ac , target: af },{source: ac , target: ad },{source: ag , target: ak },{source: af , target: ak },{source: af , target: ag },{source: ad , target: ak },{source: ad , target: ag },{source: ad , target: af },{source: aa , target: ac },{source: aa , target: ak },{source: aa , target: ag },{source: aa , target: af },{source: aa , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 185000);

setTimeout(function() { console.log('remv38'); var rm = [ 'ac','ak','af','ad','aa' ]; rmNodes(rm); rmLinks(rm); start(); }, 188750);

setTimeout(function() { console.log('load39'); var  ag = nodes[4],an = {id: 'an', name:'martin'},bd = {id: 'bd', name:'atzwanger'} ; nodes.push( an,bd ); links.push( {source: an , target: bd },{source: ag , target: bd },{source: ag , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Szene';
}, 190000);

setTimeout(function() { console.log('remv39'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 193750);

setTimeout(function() { console.log('load40'); var  af = {id: 'af', name:'herwig'},ag = nodes[0],an = nodes[1],bd = nodes[2] ; nodes.push( af ); links.push( {source: an , target: bd },{source: af , target: bd },{source: af , target: an },{source: af , target: ag },{source: ag , target: bd },{source: ag , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Szene';
}, 195000);
