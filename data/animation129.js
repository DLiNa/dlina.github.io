...
setTimeout(function() { console.log('load18'); var  ab = nodes[0],ao = {id: 'ao', name:'beller'} ; nodes.push( ao ); links.push( {source: ab , target: ao } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene';
}, 85000);
...
setTimeout(function() { console.log('load20'); var  am = nodes[0],an = nodes[1] ; /* nodes.push(); */ links.push( {source: am , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Szene';
}, 95000);
...
setTimeout(function() { console.log('load29'); var  ah = {id: 'ah', name:'barbara'},ai = nodes[0],am = {id: 'am', name:'schalanter'},aw = {id: 'aw', name:'mostinger'} ; nodes.push( ah,am,aw ); links.push( {source: am , target: aw },{source: ah , target: am },{source: ah , target: ai },{source: ah , target: aw },{source: ai , target: am },{source: ai , target: aw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene';
}, 140000);
...
setTimeout(function() { console.log('load38'); var  aa = nodes[0],ac = {id: 'ac', name:'hutterer'},ad = {id: 'ad', name:'sidonie'},af = {id: 'af', name:'herwig'},ag = {id: 'ag', name:'eduard'},ak = nodes[1] ; nodes.push( ac,ad,af,ag ); links.push( {source: ac , target: ak },{source: ac , target: ag },{source: ac , target: af },{source: ac , target: ad },{source: ag , target: ak },{source: af , target: ak },{source: af , target: ag },{source: ad , target: ak },{source: ad , target: ag },{source: ad , target: af },{source: aa , target: ac },{source: aa , target: ak },{source: aa , target: ag },{source: aa , target: af },{source: aa , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 185000);

setTimeout(function() { console.log('remv38'); var rm = [ 'ac','ak','af','ad','aa' ]; rmNodes(rm); rmLinks(rm); start(); }, 188750);

setTimeout(function() { console.log('load39'); var  ag = nodes[0],an = {id: 'an', name:'martin'},bd = {id: 'bd', name:'atzwanger'} ; nodes.push( an,bd ); links.push( {source: an , target: bd },{source: ag , target: bd },{source: ag , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Szene';
}, 190000);
