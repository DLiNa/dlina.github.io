...
setTimeout(function() { console.log('load6'); var  aa = nodes[0],ab = nodes[1],ad = {id: 'ad', name:'alberichs_stimme'},ad = {id: 'ad', name:'alberichs_stimme'},af = nodes[3] ; nodes.push( ad ); links.push( {source: ad , target: af },{source: aa , target: ad },{source: aa , target: ab },{source: aa , target: af },{source: aa , target: ad },{source: ab , target: ad },{source: ab , target: af },{source: ab , target: ad },{source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 25000);
