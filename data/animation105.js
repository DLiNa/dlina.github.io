setTimeout(function() { console.log('load1'); var  aa = {id: 'aa', name:'mime'},ab = {id: 'ab', name:'siegfried'} ; nodes.push( aa,ab ); links.push( {source: aa , target: ab } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 0);

setTimeout(function() { console.log('remv1'); var rm = [ 'ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 3750);

setTimeout(function() { console.log('load2'); var  aa = nodes[0],ac = {id: 'ac', name:'wandrer'},ac = {id: 'ac', name:'wandrer'} ; nodes.push( ac ); links.push( {source: aa , target: ac },{source: aa , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene';
}, 5000);
...
setTimeout(function() { console.log('load4'); var  ac = {id: 'ac', name:'wandrer'},ad = {id: 'ad', name:'alberichs_stimme'},ae = {id: 'ae', name:'fafners_stimme'},ae = {id: 'ae', name:'fafners_stimme'} ; nodes.push( ac,ad,ae ); links.push( {source: ad , target: ae },{source: ad , target: ae },{source: ac , target: ad },{source: ac , target: ae },{source: ac , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 15000);
...
setTimeout(function() { console.log('load6'); var  aa = nodes[0],ab = nodes[1],ad = {id: 'ad', name:'alberichs_stimme'},ad = {id: 'ad', name:'alberichs_stimme'},af = nodes[3] ; nodes.push( ad,af ); links.push( {source: ad , target: af },{source: aa , target: ad },{source: aa , target: ab },{source: aa , target: af },{source: aa , target: ad },{source: ab , target: ad },{source: ab , target: af },{source: ab , target: ad },{source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 25000);
...
setTimeout(function() { console.log('load8'); var  ab = {id: 'ab', name:'siegfried'},ac = nodes[0],ah = {id: 'ah', name:'brünnhilde'} ; nodes.push( ab,ah ); links.push( {source: ac , target: ah },{source: ab , target: ac },{source: ab , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene';
}, 35000);
