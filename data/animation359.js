...
setTimeout(function() { console.log('load2'); var  aa = {id: 'aa', name:'wilhelmina'},aa = {id: 'aa', name:'wilhelmina'},ae = nodes[1] ; nodes.push( aa ); links.push( {source: aa , target: ae },{source: aa , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Der zweyte Auftritt.';
}, 5000);
...
setTimeout(function() { console.log('load5'); var  ab = nodes[0],ac = {id: 'ac', name:'johann'} ; nodes.push( ac ); links.push( {source: ab , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Der fünfte Auftritt.';
}, 20000);
...
setTimeout(function() { console.log('load17'); var  aa = {id: 'aa', name:'wilhelmina'},ac = nodes[0],ad = nodes[1],ae = {id: 'ae', name:'orbil'} ; nodes.push( aa,ae ); links.push( {source: ad , target: ae },{source: aa , target: ad },{source: aa , target: ae },{source: aa , target: ac },{source: ac , target: ad },{source: ac , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '17. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Der siebenzehnte Auftritt.';
}, 80000);
