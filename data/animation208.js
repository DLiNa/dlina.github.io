...
setTimeout(function() { console.log('load11'); var  av = nodes[7],aw = {id: 'aw', name:'rosalie'},ax = {id: 'ax', name:'brigitte'} ; nodes.push( aw,ax ); links.push( {source: aw , target: ax },{source: av , target: aw },{source: av , target: ax } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt';
}, 50000);
...
setTimeout(function() { console.log('load18'); var  bc = nodes[0],be = nodes[2],bf = {id: 'bf', name:'von_der_wart'} ; nodes.push( bf ); links.push( {source: bc , target: bf },{source: bc , target: be },{source: be , target: bf } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
}, 85000);
...
setTimeout(function() { console.log('load29'); var  af = nodes[1],bp = {id: 'bp', name:'der_cherub'} ; nodes.push( bp ); links.push( {source: af , target: bp } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '14. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierzehnter Auftritt';
}, 140000);
...
setTimeout(function() { console.log('load36'); var  aw = nodes[1],bs = {id: 'bs', name:'eleonore'} ; nodes.push( bs ); links.push( {source: aw , target: bs } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 175000);
...
setTimeout(function() { console.log('load38'); var  af = nodes[0],bs = nodes[3] ; /* nodes.push(); */ links.push( {source: af , target: bs } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
}, 185000);
