...
setTimeout(function() { console.log('load32'); var  ae = {id: 'ae', name:'ulrich'},bl = {id: 'bl', name:'mehrere_stimmen'},bx = nodes[0],by = nodes[1],bz = nodes[2],ca = nodes[3],cb = nodes[4],ce = nodes[5] ; nodes.push( ae,bl,ce ); links.push( {source: ae , target: by },{source: ae , target: bx },{source: ae , target: ca },{source: ae , target: bz },{source: ae , target: cb },{source: ae , target: ce },{source: ae , target: bl },{source: by , target: ca },{source: by , target: bz },{source: by , target: cb },{source: by , target: ce },{source: bx , target: by },{source: bx , target: ca },{source: bx , target: bz },{source: bx , target: cb },{source: bx , target: ce },{source: ca , target: cb },{source: ca , target: ce },{source: bz , target: ca },{source: bz , target: cb },{source: bz , target: ce },{source: cb , target: ce },{source: bl , target: by },{source: bl , target: bx },{source: bl , target: ca },{source: bl , target: bz },{source: bl , target: cb },{source: bl , target: ce } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
}, 155000);
