...
setTimeout(function() { console.log('load7'); var  af = {id: 'af', name:'calcagno'},ag = {id: 'ag', name:'sacco'},ai = nodes[0],al = {id: 'al', name:'masken'},am = nodes[1],an = {id: 'an', name:'verrina'} ; nodes.push( af,ag,al,an ); links.push( {source: ai , target: al },{source: ai , target: am },{source: ai , target: an },{source: al , target: am },{source: al , target: an },{source: am , target: an },{source: af , target: ai },{source: af , target: al },{source: af , target: am },{source: af , target: an },{source: af , target: ag },{source: ag , target: ai },{source: ag , target: al },{source: ag , target: am },{source: ag , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
}, 30000);

setTimeout(function() { console.log('remv7'); var rm = [ 'al','an','af','ag' ]; rmNodes(rm); rmLinks(rm); start(); }, 33750);

setTimeout(function() { console.log('load8'); var  ai = nodes[0],am = nodes[1],ao = {id: 'ao', name:'bourgognino'} ; nodes.push( ao ); links.push( {source: am , target: ao },{source: ai , target: am },{source: ai , target: ao } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
}, 35000);
