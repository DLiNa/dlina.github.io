...
setTimeout(function() { console.log('load9'); var  ab = {id: 'ab', name:'grundman'},ab = {id: 'ab', name:'grundman'},ae = nodes[1],af = nodes[2],ag = nodes[3] ; nodes.push( ab ); links.push( {source: ab , target: ag },{source: ab , target: ae },{source: ab , target: af },{source: ae , target: ag },{source: ae , target: af },{source: ab , target: ag },{source: ab , target: ae },{source: ab , target: af },{source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
}, 40000);

setTimeout(function() { console.log('remv9'); var rm = [ 'ab','af' ]; rmNodes(rm); rmLinks(rm); start(); }, 43750);

setTimeout(function() { console.log('load10'); var  ac = {id: 'ac', name:'ferdinand'},ad = {id: 'ad', name:'lanngers'},ad = {id: 'ad', name:'lanngers'},ae = nodes[2],ag = nodes[3],ah = {id: 'ah', name:'bedienter'} ; nodes.push( ac,ad,ah ); links.push( {source: ae , target: ah },{source: ae , target: ag },{source: ag , target: ah },{source: ac , target: ah },{source: ac , target: ae },{source: ac , target: ag },{source: ac , target: ad },{source: ac , target: ad },{source: ad , target: ah },{source: ad , target: ae },{source: ad , target: ag },{source: ad , target: ah },{source: ad , target: ae },{source: ad , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 45000);
...
setTimeout(function() { console.log('load14'); var  aa = nodes[0],ai = nodes[1] ; /* nodes.push(); */ links.push( {source: aa , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
}, 65000);
