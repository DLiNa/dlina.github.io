...
setTimeout(function() { console.log('load8'); var  aa = nodes[0],ac = nodes[1],ad = nodes[2],ae = nodes[3],ae = nodes[3],af = nodes[4],ag = nodes[5],ah = {id: 'ah', name:'chor'} ; nodes.push( ae,ah ); links.push( {source: ae , target: ah },{source: ae , target: ag },{source: ae , target: af },{source: ae , target: ah },{source: ae , target: ag },{source: ae , target: af },{source: ac , target: ae },{source: ac , target: ae },{source: ac , target: ah },{source: ac , target: ag },{source: ac , target: ad },{source: ac , target: af },{source: aa , target: ae },{source: aa , target: ae },{source: aa , target: ac },{source: aa , target: ah },{source: aa , target: ag },{source: aa , target: ad },{source: aa , target: af },{source: ag , target: ah },{source: ad , target: ae },{source: ad , target: ae },{source: ad , target: ah },{source: ad , target: ag },{source: ad , target: af },{source: af , target: ah },{source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt.';
}, 35000);
