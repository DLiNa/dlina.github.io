...
setTimeout(function() { console.log('load9'); var  aa = nodes[0],ae = nodes[3] ; /* nodes.push(); */ links.push( {source: aa , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = 'Nr. 9. Arie'; var scene = document.getElementById('scene');scene.innerHTML = 'Nr. 9. Arie.';
}, 40000);
