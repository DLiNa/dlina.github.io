...
setTimeout(function() { console.log('load2'); var  aa = nodes[0],ab = nodes[2],ac = {id: 'ac', name:'sturz'} ; nodes.push( ac ); links.push( {source: ab , target: ac },{source: aa , target: ac },{source: aa , target: ab } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
}, 5000);
...
setTimeout(function() { console.log('load6'); var  ac = {id: 'ac', name:'sturz'},ad = nodes[0],ae = nodes[1],ah = nodes[4],ai = nodes[5] ; nodes.push( ac ); links.push( {source: ah , target: ai },{source: ad , target: ah },{source: ad , target: ai },{source: ad , target: ae },{source: ac , target: ah },{source: ac , target: ad },{source: ac , target: ai },{source: ac , target: ae },{source: ae , target: ah },{source: ae , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt';
}, 25000);
...
setTimeout(function() { console.log('load18'); var  aj = nodes[0],as = {id: 'as', name:'gertrud'},at = {id: 'at', name:'agnes'},cf = nodes[2] ; nodes.push( as,at ); links.push( {source: aj , target: as },{source: aj , target: at },{source: aj , target: cf },{source: as , target: at },{source: as , target: cf },{source: at , target: cf } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '18. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achtzehnter Auftritt';
}, 85000);
...
setTimeout(function() { console.log('load22'); var  ax = nodes[1],ay = {id: 'ay', name:'barbara'} ; nodes.push( ay ); links.push( {source: ax , target: ay } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
}, 105000);
...
setTimeout(function() { console.log('load50'); var  ah = nodes[2],br = {id: 'br', name:'stimmen'} ; nodes.push( br ); links.push( {source: ah , target: br } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
}, 245000);

setTimeout(function() { console.log('remv50'); var rm = [ 'ah' ]; rmNodes(rm); rmLinks(rm); start(); }, 248750);

setTimeout(function() { console.log('load51'); var  ad = {id: 'ad', name:'perwenitz'},ai = {id: 'ai', name:'sechelweg'},br = nodes[1] ; nodes.push( ad,ai ); links.push( {source: ai , target: br },{source: ad , target: br },{source: ad , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt';
}, 250000);
...
setTimeout(function() { console.log('load59'); var  ad = {id: 'ad', name:'perwenitz'},aj = nodes[0],as = nodes[2] ; nodes.push( ad ); links.push( {source: aj , target: as },{source: ad , target: aj },{source: ad , target: as } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
}, 290000);
...
setTimeout(function() { console.log('load65'); var  bc = {id: 'bc', name:'dietrich'},be = nodes[1] ; nodes.push( bc ); links.push( {source: bc , target: be } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
}, 320000);
...
setTimeout(function() { console.log('load69'); var  be = nodes[3] ; /* nodes.push(); */ links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
}, 340000);
