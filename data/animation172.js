...
setTimeout(function() { console.log('load3');nodes.sort(compare); /* ad ae af */ var  ad = {id: 'ad', name:'perwenitz'},ae = {id: 'ae', name:'rieneke'},af = {id: 'af', name:'lang'} ; nodes.push( ad,ae,af ); links.push( {source: ad , target: ae },{source: ad , target: af },{source: ad , target: af },{source: ae , target: af },{source: ae , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load4');nodes.sort(compare); /* ad ag */ var  ad = nodes[0] ,ag = {id: 'ag', name:'martin'} ; nodes.push( ag ); links.push( {source: ad , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load9');nodes.sort(compare); /* al */ var  al = {id: 'al', name:'käthe'} ; nodes.push( al ); links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load10');nodes.sort(compare); /* ak am */ var  ak = {id: 'ak', name:'finke'},am = {id: 'am', name:'grethe'} ; nodes.push( ak,am ); links.push( {source: ak , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load11');nodes.sort(compare); /* ak al am an */ var  ak = nodes[0] ,al = {id: 'al', name:'käthe'},am = nodes[1] ,an = {id: 'an', name:'knecht_1.11'} ; nodes.push( al,an ); links.push( {source: ak , target: an },{source: ak , target: am },{source: ak , target: al },{source: am , target: an },{source: al , target: an },{source: al , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfter Auftritt';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '15.277777777777777778%' ;
}, 50000);

setTimeout(function() { console.log('remv11'); var rm = [ 'an' ]; rmNodes(rm); rmLinks(rm); start(); }, 53750);

setTimeout(function() { console.log('load12');nodes.sort(compare); /* ak al am ao */ var  ak = nodes[0] ,al = nodes[1] ,am = nodes[2] ,ao = {id: 'ao', name:'rieke'} ; nodes.push( ao ); links.push( {source: al , target: ao },{source: al , target: am },{source: am , target: ao },{source: ak , target: al },{source: ak , target: ao },{source: ak , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load16');nodes.sort(compare); /* aj cf */ var  aj = {id: 'aj', name:'stroband'},cf = {id: 'cf', name:'wins'} ; nodes.push( aj,cf ); links.push( {source: aj , target: cf } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '16. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechzehnter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load21');nodes.sort(compare); /* aw ax */ var  aw = {id: 'aw', name:'briesen'},ax = {id: 'ax', name:'schwerin'} ; nodes.push( aw,ax ); links.push( {source: aw , target: ax } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load22');nodes.sort(compare); /* ax ay */ var  ax = nodes[0] ,ay = {id: 'ay', name:'barbara'} ; nodes.push( ay ); links.push( {source: ax , target: ay } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load27');nodes.sort(compare); /* ay bc be */ var  ay = nodes[0] ,bc = nodes[1] ,be = {id: 'be', name:'schwalbe'} ; nodes.push( be ); links.push( {source: bc , target: be },{source: ay , target: be },{source: ay , target: bc } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load28');nodes.sort(compare); /* ap ay bc */ var  ap = {id: 'ap', name:'quitzow'},ay = nodes[0] ,bc = nodes[1]  ; nodes.push( ap ); links.push( {source: ap , target: bc },{source: ap , target: ay },{source: ay , target: bc } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load39');nodes.sort(compare); /* as at */ var  as = {id: 'as', name:'gertrud'},at = {id: 'at', name:'agnes'} ; nodes.push( as,at ); links.push( {source: as , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load40');nodes.sort(compare); /* as at be bp */ var  as = nodes[0] ,at = nodes[1] ,be = {id: 'be', name:'schwalbe'},bp = {id: 'bp', name:'schwabe'} ; nodes.push( be,bp ); links.push( {source: as , target: be },{source: as , target: bp },{source: as , target: at },{source: be , target: bp },{source: at , target: be },{source: at , target: bp } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load43');nodes.sort(compare); /* bl bq */ var  bl = {id: 'bl', name:'ileburg'},bq = {id: 'bq', name:'friedrich'} ; nodes.push( bl,bq ); links.push( {source: bl , target: bq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '59.722222222222222222%' ;
}, 210000);

setTimeout(function() { console.log('remv43'); var rm = [ 'bq','bl' ]; rmNodes(rm); rmLinks(rm); start(); }, 213750);

setTimeout(function() { console.log('load44');nodes.sort(compare); /* ap at */ var  ap = {id: 'ap', name:'quitzow'},at = {id: 'at', name:'agnes'} ; nodes.push( ap,at ); links.push( {source: ap , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load45');nodes.sort(compare); /* ap as */ var  ap = nodes[0] ,as = {id: 'as', name:'gertrud'} ; nodes.push( as ); links.push( {source: ap , target: as } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load46');nodes.sort(compare); /* ap bq */ var  ap = nodes[0] ,bq = {id: 'bq', name:'friedrich'} ; nodes.push( bq ); links.push( {source: ap , target: bq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load57');nodes.sort(compare); /* aj as */ var  aj = nodes[0] ,as = {id: 'as', name:'gertrud'} ; nodes.push( as ); links.push( {source: aj , target: as } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load58');nodes.sort(compare); /* aj ao as at */ var  aj = nodes[0] ,ao = {id: 'ao', name:'rieke'},as = nodes[1] ,at = {id: 'at', name:'agnes'} ; nodes.push( ao,at ); links.push( {source: aj , target: at },{source: aj , target: ao },{source: aj , target: as },{source: ao , target: at },{source: ao , target: as },{source: as , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load59');nodes.sort(compare); /* ad aj as */ var  ad = {id: 'ad', name:'perwenitz'},aj = nodes[0] ,as = nodes[1]  ; nodes.push( ad ); links.push( {source: aj , target: as },{source: ad , target: aj },{source: ad , target: as } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '81.944444444444444444%' ;
}, 290000);

setTimeout(function() { console.log('remv59'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 293750);

setTimeout(function() { console.log('load60');nodes.sort(compare); /* ad aj ao as at */ var  ad = nodes[0] ,aj = nodes[1] ,ao = {id: 'ao', name:'rieke'},as = nodes[2] ,at = {id: 'at', name:'agnes'} ; nodes.push( ao,at ); links.push( {source: ad , target: ao },{source: ad , target: aj },{source: ad , target: as },{source: ad , target: at },{source: ao , target: as },{source: ao , target: at },{source: aj , target: ao },{source: aj , target: as },{source: aj , target: at },{source: as , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load61');nodes.sort(compare); /* ad aj ak ao */ var  ad = nodes[0] ,aj = nodes[1] ,ak = {id: 'ak', name:'finke'},ao = nodes[2]  ; nodes.push( ak ); links.push( {source: aj , target: ao },{source: aj , target: ak },{source: ak , target: ao },{source: ad , target: ao },{source: ad , target: aj },{source: ad , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '84.722222222222222222%' ;
}, 300000);

setTimeout(function() { console.log('remv61'); var rm = [ 'ao','aj','ak','ad' ]; rmNodes(rm); rmLinks(rm); start(); }, 303750);

setTimeout(function() { console.log('load62');nodes.sort(compare); /* ce */ var  ce = {id: 'ce', name:'knechte_am_fenster'} ; nodes.push( ce ); links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load63');nodes.sort(compare); /* be cd */ var  be = {id: 'be', name:'schwalbe'},cd = {id: 'cd', name:'knecht'} ; nodes.push( be,cd ); links.push( {source: be , target: cd } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load64');nodes.sort(compare); /* ap be */ var  ap = {id: 'ap', name:'quitzow'},be = nodes[0]  ; nodes.push( ap ); links.push( {source: ap , target: be } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load65');nodes.sort(compare); /* bc be */ var  bc = {id: 'bc', name:'dietrich'},be = nodes[0]  ; nodes.push( bc ); links.push( {source: bc , target: be } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '90.277777777777777778%' ;
}, 320000);

setTimeout(function() { console.log('remv65'); var rm = [ 'be' ]; rmNodes(rm); rmLinks(rm); start(); }, 323750);

setTimeout(function() { console.log('load66');nodes.sort(compare); /* bc cd */ var  bc = nodes[0] ,cd = {id: 'cd', name:'knecht'} ; nodes.push( cd ); links.push( {source: bc , target: cd } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load67');nodes.sort(compare); /* ay bc cd ce */ var  ay = {id: 'ay', name:'barbara'},bc = nodes[0] ,cd = nodes[1] ,ce = {id: 'ce', name:'knechte_am_fenster'} ; nodes.push( ay,ce ); links.push( {source: cd , target: ce },{source: ay , target: cd },{source: ay , target: bc },{source: ay , target: ce },{source: bc , target: cd },{source: bc , target: ce } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '93.055555555555555556%' ;
}, 330000);

setTimeout(function() { console.log('remv67'); var rm = [ 'ce' ]; rmNodes(rm); rmLinks(rm); start(); }, 333750);

setTimeout(function() { console.log('load68');nodes.sort(compare); /* ap ay bc be cd */ var  ap = {id: 'ap', name:'quitzow'},ay = nodes[0] ,bc = nodes[1] ,be = {id: 'be', name:'schwalbe'},cd = nodes[2]  ; nodes.push( ap,be ); links.push( {source: be , target: cd },{source: bc , target: cd },{source: bc , target: be },{source: ap , target: cd },{source: ap , target: be },{source: ap , target: bc },{source: ap , target: ay },{source: ay , target: cd },{source: ay , target: be },{source: ay , target: bc } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load69');nodes.sort(compare); /* be */ var  be = nodes[0]  ; /* nodes.push(); */ links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load70');nodes.sort(compare); /* cf */ var  cf = {id: 'cf', name:'wins'} ; nodes.push( cf ); links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt';
var progressbar = document.getElementById('progressiveBar');
...
setTimeout(function() { console.log('load71');nodes.sort(compare); /* ap ay bc be cd ce */ var  ap = {id: 'ap', name:'quitzow'},ay = {id: 'ay', name:'barbara'},bc = {id: 'bc', name:'dietrich'},be = {id: 'be', name:'schwalbe'},cd = {id: 'cd', name:'knecht'},ce = {id: 'ce', name:'knechte_am_fenster'} ; nodes.push( ap,ay,bc,be,cd,ce ); links.push( {source: cd , target: ce },{source: bc , target: cd },{source: bc , target: ce },{source: bc , target: be },{source: ap , target: cd },{source: ap , target: bc },{source: ap , target: ay },{source: ap , target: ce },{source: ap , target: be },{source: ay , target: cd },{source: ay , target: bc },{source: ay , target: ce },{source: ay , target: be },{source: be , target: cd },{source: be , target: ce } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt';
var progressbar = document.getElementById('progressiveBar');
progressbar.style.width = '98.611111111111111111%' ;
}, 350000);

setTimeout(function() { console.log('remv71'); var rm = [ 'cd','bc','ay','ce','be' ]; rmNodes(rm); rmLinks(rm); start(); }, 353750);

setTimeout(function() { console.log('load72');nodes.sort(compare); /* ap bq */ var  ap = nodes[0] ,bq = {id: 'bq', name:'friedrich'} ; nodes.push( bq ); links.push( {source: ap , target: bq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'Verwandlung'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfter Auftritt';
var progressbar = document.getElementById('progressiveBar');
