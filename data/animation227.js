...
setTimeout(function() { console.log('load8'); var  ah = nodes[0],aj = nodes[2],al = {id: 'al', name:'ratsherr'},am = nodes[3],an = {id: 'an', name:'la_hire'} ; nodes.push( al,an ); links.push( {source: aj , target: an },{source: aj , target: am },{source: aj , target: al },{source: ah , target: aj },{source: ah , target: an },{source: ah , target: am },{source: ah , target: al },{source: am , target: an },{source: al , target: an },{source: al , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 35000);

setTimeout(function() { console.log('remv8'); var rm = [ 'an','ah','am','al' ]; rmNodes(rm); rmLinks(rm); start(); }, 38750);

setTimeout(function() { console.log('load9'); var  ai = {id: 'ai', name:'du_chatel'},aj = nodes[1] ; nodes.push( ai ); links.push( {source: ai , target: aj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt';
}, 40000);

setTimeout(function() { console.log('remv9'); var rm = [ 'ai' ]; rmNodes(rm); rmLinks(rm); start(); }, 43750);

setTimeout(function() { console.log('load10'); var  aj = nodes[1],am = {id: 'am', name:'sorel'} ; nodes.push( am ); links.push( {source: aj , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
}, 45000);
...
setTimeout(function() { console.log('load24'); var  ah = nodes[1],an = nodes[2] ; /* nodes.push(); */ links.push( {source: ah , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt';
}, 115000);
...
setTimeout(function() { console.log('load26'); var  aj = nodes[1],am = nodes[3],ao = nodes[4],au = {id: 'au', name:'burgund'} ; nodes.push( au ); links.push( {source: aj , target: au },{source: aj , target: am },{source: aj , target: ao },{source: am , target: au },{source: am , target: ao },{source: ao , target: au } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
}, 125000);
...
setTimeout(function() { console.log('load30'); var  ah = {id: 'ah', name:'dunois'},aj = {id: 'aj', name:'könig'},au = {id: 'au', name:'burgund'},bi = nodes[2] ; nodes.push( ah,aj,au ); links.push( {source: au , target: bi },{source: ah , target: au },{source: ah , target: aj },{source: ah , target: bi },{source: aj , target: au },{source: aj , target: bi } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
}, 145000);
...
setTimeout(function() { console.log('load39'); var  ab = {id: 'ab', name:'louison'},ad = {id: 'ad', name:'margot'},af = nodes[1] ; nodes.push( ab,ad ); links.push( {source: ab , target: ad },{source: ab , target: af },{source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 190000);
...
setTimeout(function() { console.log('load49'); var  bn = nodes[1],bo = nodes[2],bp = {id: 'bp', name:'köhlerbub'} ; nodes.push( bp ); links.push( {source: bo , target: bp },{source: bn , target: bo },{source: bn , target: bp } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
}, 240000);
...
setTimeout(function() { console.log('load52'); var  ag = nodes[1],br = nodes[4] ; /* nodes.push(); */ links.push( {source: ag , target: br } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt';
}, 255000);
