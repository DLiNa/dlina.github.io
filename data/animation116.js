...
setTimeout(function() { console.log('load8'); var  al = {id: 'al', name:'linda'},am = nodes[1] ; nodes.push( al ); links.push( {source: al , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
}, 35000);
...
setTimeout(function() { console.log('load10'); var  ak = {id: 'ak', name:'tutu'},am = {id: 'am', name:'zoraide'},an = {id: 'an', name:'hassar'},ap = nodes[1],aq = {id: 'aq', name:'quecksilbers_diener'} ; nodes.push( ak,am,an,aq ); links.push( {source: ak , target: an },{source: ak , target: am },{source: ak , target: ap },{source: ak , target: aq },{source: an , target: ap },{source: an , target: aq },{source: am , target: an },{source: am , target: ap },{source: am , target: aq },{source: ap , target: aq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt';
}, 45000);
...
setTimeout(function() { console.log('load19'); var  ak = nodes[1],am = {id: 'am', name:'zoraide'} ; nodes.push( am ); links.push( {source: ak , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
}, 90000);

setTimeout(function() { console.log('remv19'); var rm = [ 'ak' ]; rmNodes(rm); rmLinks(rm); start(); }, 93750);

setTimeout(function() { console.log('load20'); var  ad = {id: 'ad', name:'quecksilber'},am = nodes[1],at = {id: 'at', name:'erster_husar'} ; nodes.push( ad,at ); links.push( {source: ad , target: am },{source: ad , target: at },{source: am , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 95000);
...
setTimeout(function() { console.log('load26'); var  am = {id: 'am', name:'zoraide'},an = nodes[2] ; nodes.push( am ); links.push( {source: am , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfter Auftritt';
}, 125000);
...
setTimeout(function() { console.log('load30'); var  ak = {id: 'ak', name:'tutu'},am = nodes[1] ; nodes.push( ak ); links.push( {source: ak , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '15. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfzehnter Auftritt';
}, 145000);
