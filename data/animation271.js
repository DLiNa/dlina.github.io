...
setTimeout(function() { console.log('load11'); var  ac = {id: 'ac', name:'gollwitz'},ah = nodes[1],ai = nodes[2] ; nodes.push( ac ); links.push( {source: ac , target: ah },{source: ac , target: ai },{source: ah , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '11. Auftritt.';
}, 50000);
...
setTimeout(function() { console.log('load13'); var  ad = nodes[0],ae = {id: 'ae', name:'marianne'},ak = nodes[2] ; nodes.push( ae ); links.push( {source: ad , target: ak },{source: ad , target: ae },{source: ae , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '2. Auftritt.';
}, 60000);
...
setTimeout(function() { console.log('load21'); var  ad = nodes[1],ah = {id: 'ah', name:'friederike'} ; nodes.push( ah ); links.push( {source: ad , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '10. Auftritt.';
}, 100000);

setTimeout(function() { console.log('remv21'); var rm = [ 'ad' ]; rmNodes(rm); rmLinks(rm); start(); }, 103750);

setTimeout(function() { console.log('load22'); var  af = {id: 'af', name:'striese'},ah = nodes[1] ; nodes.push( af ); links.push( {source: af , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '11. Auftritt.';
}, 105000);
...
setTimeout(function() { console.log('load36'); var  ac = {id: 'ac', name:'gollwitz'},ad = {id: 'ad', name:'neumeister'},ae = nodes[1],ah = nodes[2] ; nodes.push( ac,ad ); links.push( {source: ad , target: ae },{source: ad , target: ah },{source: ac , target: ad },{source: ac , target: ae },{source: ac , target: ah },{source: ae , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '13. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '13. Auftritt.';
}, 175000);
...
setTimeout(function() { console.log('load46'); var  aa = {id: 'aa', name:'rosa'},ac = nodes[0],af = {id: 'af', name:'striese'},ah = nodes[4] ; nodes.push( aa,af ); links.push( {source: af , target: ah },{source: ac , target: af },{source: ac , target: ah },{source: aa , target: af },{source: aa , target: ah },{source: aa , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = '8. Auftritt.';
}, 225000);
