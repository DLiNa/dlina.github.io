...
setTimeout(function() { console.log('load5'); var  af = {id: 'af', name:'fritz'},ag = {id: 'ag', name:'gustchen'} ; nodes.push( af,ag ); links.push( {source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Szene';
}, 20000);
...
setTimeout(function() { console.log('load35'); var  ab = {id: 'ab', name:'major'},ac = nodes[0],af = nodes[1],ai = nodes[2],ax = {id: 'ax', name:'der_alte_pätus'} ; nodes.push( ab,ax ); links.push( {source: ab , target: ax },{source: ab , target: ac },{source: ab , target: af },{source: ab , target: ai },{source: ac , target: ax },{source: ac , target: af },{source: ac , target: ai },{source: af , target: ax },{source: af , target: ai },{source: ai , target: ax } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '12. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Letzte Szene';
}, 170000);
