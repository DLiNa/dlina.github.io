...
setTimeout(function() { console.log('load16'); var  ae = nodes[0],af = {id: 'af', name:'bittermann'},ag = nodes[1],ag = nodes[1],ah = {id: 'ah', name:'graf'},ah = {id: 'ah', name:'graf'},ai = {id: 'ai', name:'gräfin'} ; nodes.push( af,ag,ah,ai ); links.push( {source: ah , target: ai },{source: ae , target: ah },{source: ae , target: ai },{source: ae , target: ag },{source: ae , target: af },{source: ae , target: ag },{source: ae , target: ah },{source: ag , target: ah },{source: ag , target: ai },{source: ag , target: ah },{source: af , target: ah },{source: af , target: ai },{source: af , target: ag },{source: af , target: ag },{source: af , target: ah },{source: ag , target: ah },{source: ag , target: ai },{source: ag , target: ah },{source: ah , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 75000);
...
setTimeout(function() { console.log('load47'); var  ac = {id: 'ac', name:'franz'},ag = nodes[0],ak = {id: 'ak', name:'wilhelm'},al = {id: 'al', name:'malchen'} ; nodes.push( ac,ag,ak,al ); links.push( {source: ak , target: al },{source: ac , target: ak },{source: ac , target: al },{source: ac , target: ag },{source: ag , target: ak },{source: ag , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt';
}, 230000);
...
setTimeout(function() { console.log('load50'); var  ab = nodes[0],ab = nodes[0],ae = {id: 'ae', name:'eulalia'},ak = {id: 'ak', name:'wilhelm'},al = {id: 'al', name:'malchen'} ; nodes.push( ab,ae,ak,al ); links.push( {source: ae , target: al },{source: ae , target: ak },{source: ab , target: ae },{source: ab , target: al },{source: ab , target: ak },{source: ab , target: ae },{source: ab , target: al },{source: ab , target: ak },{source: ak , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt';
}, 245000);
