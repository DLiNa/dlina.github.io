...
setTimeout(function() { console.log('load3'); var  aa = {id: 'aa', name:'k4_Zauberkönig'},ab = nodes[0],af = nodes[1] ; nodes.push( aa ); links.push( {source: aa , target: ab },{source: aa , target: af },{source: ab , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Erstes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 10000);
...
setTimeout(function() { console.log('load8'); var  ab = nodes[0],ac = nodes[1],ah = {id: 'ah', name:'k4_Havlitschek'} ; nodes.push( ah ); links.push( {source: ac , target: ah },{source: ab , target: ah },{source: ab , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Erstes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 35000);
...
setTimeout(function() { console.log('load10'); var  ab = nodes[0],ad = {id: 'ad', name:'k4_Mathilde'},ae = nodes[1] ; nodes.push( ad ); links.push( {source: ad , target: ae },{source: ab , target: ad },{source: ab , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Erstes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 45000);
...
setTimeout(function() { console.log('load12'); var  ad = nodes[0],ae = nodes[1] ; /* nodes.push(); */ links.push( {source: ad , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Zweites Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 55000);
...
setTimeout(function() { console.log('load14'); var  ab = {id: 'ab', name:'k4_Marianne'},ae = nodes[0] ; nodes.push( ab ); links.push( {source: ab , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Zweites Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 65000);
...
setTimeout(function() { console.log('load20'); var  aa = nodes[0],ad = nodes[1] ; /* nodes.push(); */ links.push( {source: aa , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Zweites Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 95000);
...
setTimeout(function() { console.log('load22'); var  ad = nodes[0],ag = nodes[1] ; /* nodes.push(); */ links.push( {source: ad , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Zweites Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 105000);
...
setTimeout(function() { console.log('load25'); var  ab = nodes[0],ae = nodes[1] ; /* nodes.push(); */ links.push( {source: ab , target: ae } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Zweites Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 120000);
...
setTimeout(function() { console.log('load30'); var  ad = {id: 'ad', name:'k4_Mathilde'},af = nodes[0] ; nodes.push( ad ); links.push( {source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Viertes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 145000);
...
setTimeout(function() { console.log('load40'); var  ad = nodes[0],aq = {id: 'aq', name:'k4_Der_Conférencier'} ; nodes.push( aq ); links.push( {source: ad , target: aq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Fuenftes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 195000);
...
setTimeout(function() { console.log('load43'); var  aa = nodes[0],af = nodes[1],ap = nodes[2] ; /* nodes.push(); */ links.push( {source: aa , target: af },{source: aa , target: ap },{source: af , target: ap } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Fuenftes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 210000);
...
setTimeout(function() { console.log('load45'); var  ab = nodes[0],ap = {id: 'ap', name:'k4_Der_Mister'} ; nodes.push( ap ); links.push( {source: ab , target: ap } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Fuenftes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 220000);
...
setTimeout(function() { console.log('load58'); var  ar = {id: 'ar', name:'k4_Die_Großmutter'},as = nodes[0] ; nodes.push( ar ); links.push( {source: ar , target: as } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Siebentes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 285000);
...
setTimeout(function() { console.log('load62'); var  ae = nodes[0],at = nodes[1] ; /* nodes.push(); */ links.push( {source: ae , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Siebentes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 305000);
...
setTimeout(function() { console.log('load65'); var  ab = nodes[0],ac = nodes[1] ; /* nodes.push(); */ links.push( {source: ab , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = 'body'; var act = document.getElementById('act');act.innerHTML = 'Siebentes Bild'; var scene = document.getElementById('scene');scene.innerHTML = 'Absatz';
}, 320000);
