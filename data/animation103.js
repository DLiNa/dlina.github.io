...
setTimeout(function() { console.log('load12'); var  ad = nodes[0],af = nodes[1],ag = nodes[2],al = {id: 'al', name:'graf_drullo'},al = {id: 'al', name:'graf_drullo'},an = {id: 'an', name:'dame_dhonneur'},ao = {id: 'ao', name:'galanteriekrämerin'} ; nodes.push( al,an,ao ); links.push( {source: ag , target: an },{source: ag , target: al },{source: ag , target: al },{source: ag , target: ao },{source: an , target: ao },{source: af , target: ag },{source: af , target: an },{source: af , target: al },{source: af , target: al },{source: af , target: ao },{source: al , target: an },{source: al , target: ao },{source: al , target: an },{source: al , target: ao },{source: ad , target: ag },{source: ad , target: an },{source: ad , target: af },{source: ad , target: al },{source: ad , target: al },{source: ad , target: ao } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 55000);
