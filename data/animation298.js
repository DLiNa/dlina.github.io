...
setTimeout(function() { console.log('load3'); var  aa = nodes[0],ab = nodes[1],ac = {id: 'ac', name:'borax'},ad = {id: 'ad', name:'antimonia'},ae = {id: 'ae', name:'lakrimosa'},af = {id: 'af', name:'ajaxerle'},ag = nodes[2],ag = nodes[2],ag = nodes[2],ah = {id: 'ah', name:'fiaker'},ai = {id: 'ai', name:'genius'},ai = {id: 'ai', name:'genius'} ; nodes.push( ac,ad,ae,af,ag,ah,ai ); links.push( {source: af , target: ag },{source: af , target: ah },{source: af , target: ag },{source: af , target: ag },{source: af , target: ai },{source: af , target: ai },{source: ab , target: af },{source: ab , target: ag },{source: ab , target: ac },{source: ab , target: ad },{source: ab , target: ae },{source: ab , target: ah },{source: ab , target: ag },{source: ab , target: ag },{source: ab , target: ai },{source: ab , target: ai },{source: ag , target: ah },{source: ag , target: ai },{source: ag , target: ai },{source: ac , target: af },{source: ac , target: ag },{source: ac , target: ad },{source: ac , target: ae },{source: ac , target: ah },{source: ac , target: ag },{source: ac , target: ag },{source: ac , target: ai },{source: ac , target: ai },{source: ad , target: af },{source: ad , target: ag },{source: ad , target: ae },{source: ad , target: ah },{source: ad , target: ag },{source: ad , target: ag },{source: ad , target: ai },{source: ad , target: ai },{source: ae , target: af },{source: ae , target: ag },{source: ae , target: ah },{source: ae , target: ag },{source: ae , target: ag },{source: ae , target: ai },{source: ae , target: ai },{source: aa , target: af },{source: aa , target: ab },{source: aa , target: ag },{source: aa , target: ac },{source: aa , target: ad },{source: aa , target: ae },{source: aa , target: ah },{source: aa , target: ag },{source: aa , target: ag },{source: aa , target: ai },{source: aa , target: ai },{source: ah , target: ai },{source: ah , target: ai },{source: ag , target: ah },{source: ag , target: ai },{source: ag , target: ai },{source: ag , target: ah },{source: ag , target: ai },{source: ag , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
}, 10000);
