...
setTimeout(function() { console.log('load17'); var  ad = {id: 'ad', name:'delomer'},ae = nodes[0],af = nodes[1],an = nodes[2] ; nodes.push( ad ); links.push( {source: ad , target: an },{source: ad , target: ae },{source: ad , target: af },{source: ae , target: an },{source: ae , target: af },{source: af , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweyter Auftritt.';
}, 80000);
...
setTimeout(function() { console.log('load22'); var  ae = nodes[0],ag = {id: 'ag', name:'graf'},an = nodes[2] ; nodes.push( ag ); links.push( {source: ag , target: an },{source: ae , target: ag },{source: ae , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '7'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt.';
}, 105000);
