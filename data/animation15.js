...
setTimeout(function() { console.log('load13'); var  ae = nodes[0],al = nodes[1],am = {id: 'am', name:'gärtner'} ; nodes.push( am ); links.push( {source: ae , target: am },{source: ae , target: al },{source: al , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '5'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt.';
}, 60000);
...
setTimeout(function() { console.log('load20'); var  ad = nodes[0],ae = {id: 'ae', name:'dominiq'},af = {id: 'af', name:'mad'},an = nodes[1] ; nodes.push( ae,af ); links.push( {source: ad , target: an },{source: ad , target: ae },{source: ad , target: af },{source: ae , target: an },{source: ae , target: af },{source: af , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '5'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt.';
}, 95000);

setTimeout(function() { console.log('remv20'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 98750);

setTimeout(function() { console.log('load21'); var  ad = nodes[0],ae = nodes[1],af = nodes[2],af = nodes[2],al = {id: 'al', name:'marquis'},an = nodes[3] ; nodes.push( af,al ); links.push( {source: al , target: an },{source: ad , target: al },{source: ad , target: af },{source: ad , target: an },{source: ad , target: af },{source: ad , target: ae },{source: af , target: al },{source: af , target: an },{source: af , target: al },{source: af , target: an },{source: ae , target: al },{source: ae , target: af },{source: ae , target: an },{source: ae , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '6'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt.';
}, 100000);

setTimeout(function() { console.log('remv21'); var rm = [ 'al','ad','af' ]; rmNodes(rm); rmLinks(rm); start(); }, 103750);

setTimeout(function() { console.log('load22'); var  ae = nodes[0],ag = {id: 'ag', name:'graf'},an = nodes[2] ; nodes.push( ae,ag ); links.push( {source: ag , target: an },{source: ae , target: ag },{source: ae , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '7'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt.';
}, 105000);
...
setTimeout(function() { console.log('load27'); var  ae = nodes[0],an = {id: 'an', name:'dominique_v'} ; nodes.push( ae,an ); links.push( {source: ae , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '12'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwölfter Auftritt.';
}, 130000);
...
setTimeout(function() { console.log('load35'); var  ad = nodes[0],af = {id: 'af', name:'mad'},af = {id: 'af', name:'mad'} ; nodes.push( af ); links.push( {source: ad , target: af },{source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '7'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt.';
}, 170000);
...
setTimeout(function() { console.log('load38'); var  ad = nodes[0],ae = nodes[1],ae = nodes[1],al = {id: 'al', name:'marquis'},an = {id: 'an', name:'dominique_v'} ; nodes.push( ae,al,an ); links.push( {source: ae , target: an },{source: ae , target: al },{source: al , target: an },{source: ad , target: an },{source: ad , target: ae },{source: ad , target: al },{source: ad , target: ae },{source: ae , target: an },{source: ae , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '10'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt.';
}, 185000);

setTimeout(function() { console.log('remv38'); var rm = [ 'ae','al' ]; rmNodes(rm); rmLinks(rm); start(); }, 188750);

setTimeout(function() { console.log('load39'); var  ad = nodes[0],an = nodes[2] ; /* nodes.push(); */ links.push( {source: ad , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '11'; var scene = document.getElementById('scene');scene.innerHTML = 'Eilfter Auftritt.';
}, 190000);
...
setTimeout(function() { console.log('load42'); var  ae = nodes[0],ak = {id: 'ak', name:'das_kind'},an = nodes[1] ; nodes.push( ak ); links.push( {source: ak , target: an },{source: ae , target: ak },{source: ae , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '14'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierzehnter Auftritt.';
}, 205000);

setTimeout(function() { console.log('remv42'); var rm = [ 'ae' ]; rmNodes(rm); rmLinks(rm); start(); }, 208750);

setTimeout(function() { console.log('load43'); var  ad = {id: 'ad', name:'delomer'},ak = nodes[0],an = nodes[1] ; nodes.push( ad ); links.push( {source: ad , target: an },{source: ad , target: ak },{source: ak , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '15'; var scene = document.getElementById('scene');scene.innerHTML = 'Funfzehnter Auftritt.';
}, 210000);
...
setTimeout(function() { console.log('load45'); var  ad = nodes[0],ae = {id: 'ae', name:'dominiq'},an = nodes[1] ; nodes.push( ae ); links.push( {source: ad , target: ae },{source: ad , target: an },{source: ae , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '17'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebzehnter Auftritt.';
}, 220000);
...
setTimeout(function() { console.log('load47'); var  ad = nodes[0],ae = nodes[1],af = {id: 'af', name:'mad'},an = {id: 'an', name:'dominique_v'} ; nodes.push( af,an ); links.push( {source: ae , target: an },{source: ae , target: af },{source: af , target: an },{source: ad , target: ae },{source: ad , target: an },{source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '19'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunzehnter Auftritt.';
}, 230000);

setTimeout(function() { console.log('remv47'); var rm = [ 'ae' ]; rmNodes(rm); rmLinks(rm); start(); }, 233750);

setTimeout(function() { console.log('load48'); var  ad = nodes[0],af = nodes[1],an = nodes[2] ; /* nodes.push(); */ links.push( {source: ad , target: an },{source: ad , target: af },{source: af , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '20'; var scene = document.getElementById('scene');scene.innerHTML = 'Zwanzigster Auftritt.';
}, 235000);

setTimeout(function() { console.log('remv48'); var rm = [ 'af' ]; rmNodes(rm); rmLinks(rm); start(); }, 238750);

setTimeout(function() { console.log('load49'); var  ab = {id: 'ab', name:'horfmann'},ad = nodes[0],ak = {id: 'ak', name:'das_kind'},an = nodes[1] ; nodes.push( ab,ak ); links.push( {source: ab , target: ak },{source: ab , target: ad },{source: ab , target: an },{source: ak , target: an },{source: ad , target: ak },{source: ad , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '21'; var scene = document.getElementById('scene');scene.innerHTML = 'Ein und zwanzigster Auftritt.';
}, 240000);

setTimeout(function() { console.log('remv49'); var rm = [ 'ab','ak' ]; rmNodes(rm); rmLinks(rm); start(); }, 243750);

setTimeout(function() { console.log('load50'); var  ad = nodes[0],ae = {id: 'ae', name:'dominiq'},al = {id: 'al', name:'marquis'},an = nodes[1] ; nodes.push( ae,al ); links.push( {source: al , target: an },{source: ad , target: al },{source: ad , target: an },{source: ad , target: ae },{source: ae , target: al },{source: ae , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '22'; var scene = document.getElementById('scene');scene.innerHTML = 'Letzter Auftritt.';
}, 245000);
