...
setTimeout(function() { console.log('load9'); var  an = nodes[0],ao = {id: 'ao', name:'alf'},ap = {id: 'ap', name:'gyldenbrog'},aq = {id: 'aq', name:'eine_stimme'},ar = {id: 'ar', name:'eine_andere_stimme'} ; nodes.push( an,ao,ap,aq,ar ); links.push( {source: ao , target: ap },{source: ao , target: aq },{source: ao , target: ar },{source: an , target: ao },{source: an , target: ap },{source: an , target: aq },{source: an , target: ar },{source: ap , target: aq },{source: ap , target: ar },{source: aq , target: ar } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Scene.';
}, 40000);
...
setTimeout(function() { console.log('load17'); var  ab = nodes[0],af = {id: 'af', name:'asla'},ag = {id: 'ag', name:'nös'},bc = {id: 'bc', name:'andere'},bc = {id: 'bc', name:'andere'},bc = {id: 'bc', name:'andere'} ; nodes.push( af,ag,bc ); links.push( {source: ab , target: af },{source: ab , target: ag },{source: ab , target: bc },{source: ab , target: bc },{source: ab , target: bc },{source: af , target: ag },{source: af , target: bc },{source: af , target: bc },{source: af , target: bc },{source: ag , target: bc },{source: ag , target: bc },{source: ag , target: bc } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Scene';
}, 80000);

setTimeout(function() { console.log('remv17'); var rm = [ 'ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 83750);

setTimeout(function() { console.log('load18'); var  af = nodes[0],ag = nodes[1],aj = {id: 'aj', name:'biörneland'},ak = {id: 'ak', name:'yngurds'},at = {id: 'at', name:'der_knapp'},au = {id: 'au', name:'stimmen'},bc = nodes[2],bd = {id: 'bd', name:'biörnelands_heerhaufe'},be = {id: 'be', name:'kurl'},bf = {id: 'bf', name:'marduff'},bg = {id: 'bg', name:'ein_knapp'} ; nodes.push( aj,ak,at,au,bc,bd,be,bf,bg ); links.push( {source: au , target: bd },{source: au , target: bc },{source: au , target: be },{source: au , target: bf },{source: au , target: bg },{source: ak , target: au },{source: ak , target: bd },{source: ak , target: bc },{source: ak , target: be },{source: ak , target: bf },{source: ak , target: bg },{source: ak , target: at },{source: aj , target: au },{source: aj , target: ak },{source: aj , target: bd },{source: aj , target: bc },{source: aj , target: be },{source: aj , target: bf },{source: aj , target: bg },{source: aj , target: at },{source: bd , target: be },{source: bd , target: bf },{source: bd , target: bg },{source: bc , target: bd },{source: bc , target: be },{source: bc , target: bf },{source: bc , target: bg },{source: be , target: bf },{source: be , target: bg },{source: ag , target: au },{source: ag , target: ak },{source: ag , target: aj },{source: ag , target: bd },{source: ag , target: bc },{source: ag , target: be },{source: ag , target: bf },{source: ag , target: bg },{source: ag , target: at },{source: bf , target: bg },{source: af , target: au },{source: af , target: ak },{source: af , target: aj },{source: af , target: bd },{source: af , target: bc },{source: af , target: be },{source: af , target: ag },{source: af , target: bf },{source: af , target: bg },{source: af , target: at },{source: at , target: au },{source: at , target: bd },{source: at , target: bc },{source: at , target: be },{source: at , target: bf },{source: at , target: bg } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Scene.';
}, 85000);

setTimeout(function() { console.log('remv18'); var rm = [ 'au','aj','bd','bc','be','ag','bf','bg','at' ]; rmNodes(rm); rmLinks(rm); start(); }, 88750);

setTimeout(function() { console.log('load19'); var  ae = {id: 'ae', name:'irma'},af = nodes[0],ak = nodes[1] ; nodes.push( ae ); links.push( {source: ae , target: ak },{source: ae , target: af },{source: af , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Scene.';
}, 90000);
