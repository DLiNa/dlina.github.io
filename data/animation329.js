...
setTimeout(function() { console.log('load2'); var  ab = nodes[1],ac = {id: 'ac', name:'rosalinde'} ; nodes.push( ac ); links.push( {source: ab , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
}, 5000);
...
setTimeout(function() { console.log('load32'); var  ad = {id: 'ad', name:'eisenstein'},ag = nodes[1] ; nodes.push( ad ); links.push( {source: ad , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 155000);
...
setTimeout(function() { console.log('load35'); var  ag = nodes[1],az = {id: 'az', name:'frosch'} ; nodes.push( az ); links.push( {source: ag , target: az } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
}, 170000);

setTimeout(function() { console.log('remv35'); var rm = [ 'ag' ]; rmNodes(rm); rmLinks(rm); start(); }, 173750);

setTimeout(function() { console.log('load36'); var  ad = {id: 'ad', name:'eisenstein'},ae = {id: 'ae', name:'blind'},az = nodes[1] ; nodes.push( ad,ae ); links.push( {source: ad , target: az },{source: ad , target: ae },{source: ae , target: az } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '9. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Neunter Auftritt';
}, 175000);

setTimeout(function() { console.log('remv36'); var rm = [ 'ad','ae' ]; rmNodes(rm); rmLinks(rm); start(); }, 178750);

setTimeout(function() { console.log('load37'); var  aa = {id: 'aa', name:'alfred'},ac = {id: 'ac', name:'rosalinde'},az = nodes[2] ; nodes.push( aa,ac ); links.push( {source: aa , target: az },{source: aa , target: ac },{source: ac , target: az } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '10. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zehnter Auftritt';
}, 180000);
...
setTimeout(function() { console.log('load40'); var  ab = {id: 'ab', name:'adele'},ac = nodes[1],ad = nodes[2],af = nodes[3],ag = nodes[4],au = {id: 'au', name:'ida'},az = {id: 'az', name:'frosch'} ; nodes.push( ab,au,az ); links.push( {source: ag , target: az },{source: ag , target: au },{source: ac , target: az },{source: ac , target: ag },{source: ac , target: au },{source: ac , target: ad },{source: ac , target: af },{source: ab , target: az },{source: ab , target: ag },{source: ab , target: ac },{source: ab , target: au },{source: ab , target: ad },{source: ab , target: af },{source: au , target: az },{source: ad , target: az },{source: ad , target: ag },{source: ad , target: au },{source: ad , target: af },{source: af , target: az },{source: af , target: ag },{source: af , target: au } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '13. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dreizehnter Auftritt';
}, 195000);
