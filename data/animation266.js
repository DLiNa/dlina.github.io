...
setTimeout(function() { console.log('load30'); var  aa = nodes[0],aa = nodes[0],ah = {id: 'ah', name:'gianotto'} ; nodes.push( aa,ah ); links.push( {source: aa , target: ah },{source: aa , target: ah } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierte Scene';
}, 145000);

setTimeout(function() { console.log('remv30'); var rm = [ 'aa' ]; rmNodes(rm); rmLinks(rm); start(); }, 148750);

setTimeout(function() { console.log('load31'); var  ac = {id: 'ac', name:'der_alte_fischer'},ah = nodes[1],ak = {id: 'ak', name:'martina'} ; nodes.push( ac,ak ); links.push( {source: ac , target: ak },{source: ac , target: ah },{source: ah , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfte Scene.';
}, 150000);

setTimeout(function() { console.log('remv31'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 153750);

setTimeout(function() { console.log('load32'); var  ac = nodes[0],ah = nodes[1],ak = nodes[2],al = {id: 'al', name:'gräfin'},an = {id: 'an', name:'stimmen'} ; nodes.push( ac,al,an ); links.push( {source: al , target: an },{source: ak , target: al },{source: ak , target: an },{source: ac , target: al },{source: ac , target: ak },{source: ac , target: an },{source: ac , target: ah },{source: ah , target: al },{source: ah , target: ak },{source: ah , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechste Scene.';
}, 155000);

setTimeout(function() { console.log('remv32'); var rm = [ 'an' ]; rmNodes(rm); rmLinks(rm); start(); }, 158750);

setTimeout(function() { console.log('load33'); var  aa = {id: 'aa', name:'don'},ab = {id: 'ab', name:'leporello'},ac = nodes[0],ac = nodes[0],ae = {id: 'ae', name:'der_karthäuser'},ae = {id: 'ae', name:'der_karthäuser'},ah = nodes[2],ai = {id: 'ai', name:'der_wirth'},ai = {id: 'ai', name:'der_wirth'},ak = nodes[4],al = nodes[5] ; nodes.push( aa,ab,ac,ae,ai ); links.push( {source: ai , target: al },{source: ai , target: ak },{source: ab , target: ai },{source: ab , target: al },{source: ab , target: ah },{source: ab , target: ak },{source: ab , target: ae },{source: ab , target: ae },{source: ab , target: ac },{source: ab , target: ai },{source: ab , target: ac },{source: ah , target: ai },{source: ah , target: al },{source: ah , target: ak },{source: ah , target: ai },{source: aa , target: ai },{source: aa , target: ab },{source: aa , target: al },{source: aa , target: ah },{source: aa , target: ak },{source: aa , target: ae },{source: aa , target: ae },{source: aa , target: ac },{source: aa , target: ai },{source: aa , target: ac },{source: ak , target: al },{source: ae , target: ai },{source: ae , target: al },{source: ae , target: ah },{source: ae , target: ak },{source: ae , target: ai },{source: ae , target: ai },{source: ae , target: al },{source: ae , target: ah },{source: ae , target: ak },{source: ae , target: ai },{source: ac , target: ai },{source: ac , target: al },{source: ac , target: ah },{source: ac , target: ak },{source: ac , target: ae },{source: ac , target: ae },{source: ac , target: ai },{source: ai , target: al },{source: ai , target: ak },{source: ac , target: ai },{source: ac , target: al },{source: ac , target: ah },{source: ac , target: ak },{source: ac , target: ae },{source: ac , target: ae },{source: ac , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Scene.';
}, 160000);
