...
setTimeout(function() { console.log('load33'); var  aa = {id: 'aa', name:'don'},ab = {id: 'ab', name:'leporello'},ac = nodes[0],ac = nodes[0],ae = {id: 'ae', name:'der_karthäuser'},ae = {id: 'ae', name:'der_karthäuser'},ah = nodes[2],ai = {id: 'ai', name:'der_wirth'},ai = {id: 'ai', name:'der_wirth'},ak = nodes[4],al = nodes[5] ; nodes.push( aa,ab,ae,ai ); links.push( {source: ai , target: al },{source: ai , target: ak },{source: ab , target: ai },{source: ab , target: al },{source: ab , target: ah },{source: ab , target: ak },{source: ab , target: ae },{source: ab , target: ae },{source: ab , target: ac },{source: ab , target: ai },{source: ab , target: ac },{source: ah , target: ai },{source: ah , target: al },{source: ah , target: ak },{source: ah , target: ai },{source: aa , target: ai },{source: aa , target: ab },{source: aa , target: al },{source: aa , target: ah },{source: aa , target: ak },{source: aa , target: ae },{source: aa , target: ae },{source: aa , target: ac },{source: aa , target: ai },{source: aa , target: ac },{source: ak , target: al },{source: ae , target: ai },{source: ae , target: al },{source: ae , target: ah },{source: ae , target: ak },{source: ae , target: ai },{source: ae , target: ai },{source: ae , target: al },{source: ae , target: ah },{source: ae , target: ak },{source: ae , target: ai },{source: ac , target: ai },{source: ac , target: al },{source: ac , target: ah },{source: ac , target: ak },{source: ac , target: ae },{source: ac , target: ae },{source: ac , target: ai },{source: ai , target: al },{source: ai , target: ak },{source: ac , target: ai },{source: ac , target: al },{source: ac , target: ah },{source: ac , target: ak },{source: ac , target: ae },{source: ac , target: ae },{source: ac , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebente Scene.';
}, 160000);
