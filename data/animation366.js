...
setTimeout(function() { console.log('load38'); var  ae = {id: 'ae', name:'kathi'},af = nodes[0],af = nodes[0],ag = nodes[1],ai = nodes[2],al = nodes[3],aq = nodes[4] ; nodes.push( ae ); links.push( {source: ae , target: af },{source: ae , target: ai },{source: ae , target: ag },{source: ae , target: al },{source: ae , target: af },{source: ae , target: aq },{source: af , target: ai },{source: af , target: ag },{source: af , target: al },{source: af , target: aq },{source: ai , target: al },{source: ai , target: aq },{source: ag , target: ai },{source: ag , target: al },{source: ag , target: aq },{source: al , target: aq },{source: af , target: ai },{source: af , target: ag },{source: af , target: al },{source: af , target: aq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweiter Auftritt';
}, 185000);
