...
setTimeout(function() { console.log('load17'); var  ae = nodes[1],ah = nodes[2],al = {id: 'al', name:'chor_der_krieger'},at = {id: 'at', name:'jägerchor'},at = {id: 'at', name:'jägerchor'} ; nodes.push( al,at ); links.push( {source: ae , target: ah },{source: ae , target: at },{source: ae , target: al },{source: ae , target: at },{source: ah , target: at },{source: ah , target: al },{source: ah , target: at },{source: al , target: at },{source: al , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '5. Scene.';
}, 80000);
