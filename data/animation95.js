...
setTimeout(function() { console.log('load5'); var  ac = nodes[2],ae = {id: 'ae', name:'pizarro'},af = {id: 'af', name:'chor_der_wache'} ; nodes.push( ae,af ); links.push( {source: ae , target: af },{source: ac , target: ae },{source: ac , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 20000);

setTimeout(function() { console.log('remv5'); var rm = [ 'ae','ac','af' ]; rmNodes(rm); rmLinks(rm); start(); }, 23750);

setTimeout(function() { console.log('load6'); var  aa = {id: 'aa', name:'jaquino'},ab = {id: 'ab', name:'marzelline'} ; nodes.push( aa,ab ); links.push( {source: aa , target: ab } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
}, 25000);
...
setTimeout(function() { console.log('load10'); var  aa = {id: 'aa', name:'jaquino'},ab = {id: 'ab', name:'marzelline'},ac = nodes[0],ad = nodes[1] ; nodes.push( aa,ab ); links.push( {source: ab , target: ac },{source: ab , target: ad },{source: ac , target: ad },{source: aa , target: ab },{source: aa , target: ac },{source: aa , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfter Auftritt';
}, 45000);
...
setTimeout(function() { console.log('load12'); var  aj = {id: 'aj', name:'florestan'} ; nodes.push( aj ); links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Erster Auftritt';
}, 55000);
...
setTimeout(function() { console.log('load18'); var  ak = {id: 'ak', name:'chor'},al = {id: 'al', name:'fernando'} ; nodes.push( ak,al ); links.push( {source: ak , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Siebenter Auftritt';
}, 85000);

setTimeout(function() { console.log('remv18'); var rm = [  ]; rmNodes(rm); rmLinks(rm); start(); }, 88750);

setTimeout(function() { console.log('load19'); var  ab = {id: 'ab', name:'marzelline'},ac = {id: 'ac', name:'rocco'},ad = {id: 'ad', name:'leonore'},ae = {id: 'ae', name:'pizarro'},aj = {id: 'aj', name:'florestan'},ak = nodes[0],al = nodes[1] ; nodes.push( ab,ac,ad,ae,aj ); links.push( {source: ac , target: ae },{source: ac , target: al },{source: ac , target: ad },{source: ac , target: ak },{source: ac , target: aj },{source: ae , target: al },{source: ae , target: ak },{source: ae , target: aj },{source: ad , target: ae },{source: ad , target: al },{source: ad , target: ak },{source: ad , target: aj },{source: ab , target: ac },{source: ab , target: ae },{source: ab , target: al },{source: ab , target: ad },{source: ab , target: ak },{source: ab , target: aj },{source: ak , target: al },{source: aj , target: al },{source: aj , target: ak } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
}, 90000);
