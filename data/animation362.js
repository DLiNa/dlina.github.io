...
setTimeout(function() { console.log('load20'); var  ac = nodes[0],ad = {id: 'ad', name:'natalie'},aw = {id: 'aw', name:'die_hofdame'} ; nodes.push( ac,ad,aw ); links.push( {source: ac , target: aw },{source: ac , target: ad },{source: ad , target: aw } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '4. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierter Auftritt';
}, 95000);
