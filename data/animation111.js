...
setTimeout(function() { console.log('load42'); var  aa = {id: 'aa', name:'fust'},af = {id: 'af', name:'bodo'},ag = {id: 'ag', name:'wallberg'},ah = {id: 'ah', name:'eckhard'},as = nodes[0],as = nodes[0],bd = nodes[1] ; nodes.push( aa,af,ag,ah,as ); links.push( {source: aa , target: bd },{source: aa , target: as },{source: aa , target: af },{source: aa , target: ag },{source: aa , target: ah },{source: aa , target: as },{source: as , target: bd },{source: af , target: bd },{source: af , target: as },{source: af , target: ag },{source: af , target: ah },{source: af , target: as },{source: ag , target: bd },{source: ag , target: as },{source: ag , target: ah },{source: ag , target: as },{source: ah , target: bd },{source: ah , target: as },{source: ah , target: as },{source: as , target: bd } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '15. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfzehnter Auftritt.';
}, 205000);
