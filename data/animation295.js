...
setTimeout(function() { console.log('load8'); var  ad = nodes[1],ae = nodes[2],af = {id: 'af', name:'ein_diener'},ar = nodes[3] ; nodes.push( af ); links.push( {source: ae , target: ar },{source: ae , target: af },{source: ad , target: ae },{source: ad , target: ar },{source: ad , target: af },{source: af , target: ar } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Achter Auftritt';
}, 35000);
...
setTimeout(function() { console.log('load22'); var  ak = nodes[1],ax = nodes[2] ; /* nodes.push(); */ links.push( {source: ak , target: ax } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Sechster Auftritt';
}, 105000);
