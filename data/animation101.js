...
setTimeout(function() { console.log('load8'); var  aj = nodes[0] ; /* nodes.push(); */ links.push(  ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene';
}, 35000);
...
setTimeout(function() { console.log('load15'); var  ab = nodes[0],ah = {id: 'ah', name:'marianne'},aj = {id: 'aj', name:'alexandra'},al = nodes[1] ; nodes.push( ah,aj ); links.push( {source: ab , target: al },{source: ab , target: aj },{source: ab , target: ah },{source: aj , target: al },{source: ah , target: al },{source: ah , target: aj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Zweite Szene';
}, 70000);
...
setTimeout(function() { console.log('load20'); var  ah = nodes[0],aj = {id: 'aj', name:'alexandra'} ; nodes.push( aj ); links.push( {source: ah , target: aj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 95000);
...
setTimeout(function() { console.log('load22'); var  ah = nodes[0],aj = nodes[1],am = {id: 'am', name:'soemus'} ; nodes.push( am ); links.push( {source: ah , target: am },{source: ah , target: aj },{source: aj , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 105000);
...
setTimeout(function() { console.log('load27'); var  ab = {id: 'ab', name:'herodes'},af = nodes[0],ah = nodes[1],al = nodes[2],am = {id: 'am', name:'soemus'} ; nodes.push( ab,am ); links.push( {source: ah , target: al },{source: ah , target: am },{source: al , target: am },{source: ab , target: ah },{source: ab , target: al },{source: ab , target: af },{source: ab , target: am },{source: af , target: ah },{source: af , target: al },{source: af , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Achte Szene';
}, 130000);

setTimeout(function() { console.log('remv27'); var rm = [ 'ah','af','am' ]; rmNodes(rm); rmLinks(rm); start(); }, 133750);

setTimeout(function() { console.log('load28'); var  ab = nodes[0],al = nodes[1] ; /* nodes.push(); */ links.push( {source: ab , target: al } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Erste Szene';
}, 135000);
