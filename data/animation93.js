...
setTimeout(function() { console.log('load7'); var  aa = nodes[0],ab = nodes[1],ac = nodes[2],ad = nodes[3],ae = nodes[4],af = nodes[5],af = nodes[5],ag = nodes[6],ah = {id: 'ah', name:'henriette'},ai = {id: 'ai', name:'johann'} ; nodes.push( af,ah,ai ); links.push( {source: ab , target: ad },{source: ab , target: ah },{source: ab , target: ae },{source: ab , target: af },{source: ab , target: af },{source: ab , target: ag },{source: ab , target: ac },{source: ab , target: ai },{source: ad , target: ah },{source: ad , target: ae },{source: ad , target: af },{source: ad , target: af },{source: ad , target: ag },{source: ad , target: ai },{source: ah , target: ai },{source: ae , target: ah },{source: ae , target: af },{source: ae , target: af },{source: ae , target: ag },{source: ae , target: ai },{source: af , target: ah },{source: af , target: ag },{source: af , target: ai },{source: af , target: ah },{source: af , target: ag },{source: af , target: ai },{source: ag , target: ah },{source: ag , target: ai },{source: aa , target: ab },{source: aa , target: ad },{source: aa , target: ah },{source: aa , target: ae },{source: aa , target: af },{source: aa , target: af },{source: aa , target: ag },{source: aa , target: ac },{source: aa , target: ai },{source: ac , target: ad },{source: ac , target: ah },{source: ac , target: ae },{source: ac , target: af },{source: ac , target: af },{source: ac , target: ag },{source: ac , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Achte Szene.';
}, 30000);
