...
setTimeout(function() { console.log('load14'); var  ag = nodes[0],aj = {id: 'aj', name:'barbara'} ; nodes.push( aj ); links.push( {source: ag , target: aj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '14. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Vierzehnte Scene';
}, 65000);
...
setTimeout(function() { console.log('load30'); var  aa = nodes[0],ad = nodes[1],aj = nodes[2] ; /* nodes.push(); */ links.push( {source: aa , target: aj },{source: aa , target: ad },{source: ad , target: aj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Scene';
}, 145000);
...
setTimeout(function() { console.log('load35'); var  ab = nodes[0],ai = nodes[1],am = {id: 'am', name:'klara'} ; nodes.push( am ); links.push( {source: ai , target: am },{source: ab , target: am },{source: ab , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Achte Scene';
}, 170000);
...
setTimeout(function() { console.log('load38'); var  aa = nodes[0],ad = {id: 'ad', name:'emma'},ai = nodes[1] ; nodes.push( ad ); links.push( {source: ad , target: ai },{source: aa , target: ad },{source: aa , target: ai } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '11. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Elfte Scene';
}, 185000);
