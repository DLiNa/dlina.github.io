...
setTimeout(function() { console.log('load32'); var  ah = nodes[0],am = nodes[3],bj = nodes[5] ; /* nodes.push(); */ links.push( {source: ah , target: am },{source: ah , target: bj },{source: am , target: bj } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = 'Dritter Akt'; var scene = document.getElementById('scene');scene.innerHTML = '17';
}, 155000);
...
setTimeout(function() { console.log('load43'); var  ac = nodes[0],ah = {id: 'ah', name:'götz'},bv = nodes[5],bw = {id: 'bw', name:'stumpf'},bw = {id: 'bw', name:'stumpf'},bx = {id: 'bx', name:'kohl'},by = {id: 'by', name:'wild'},bz = {id: 'bz', name:'linz'} ; nodes.push( ah,bw,bx,by,bz ); links.push( {source: bw , target: bx },{source: bw , target: by },{source: bw , target: bz },{source: bx , target: by },{source: bx , target: bz },{source: ah , target: bw },{source: ah , target: bx },{source: ah , target: by },{source: ah , target: bw },{source: ah , target: bv },{source: ah , target: bz },{source: by , target: bz },{source: bw , target: bx },{source: bw , target: by },{source: bw , target: bz },{source: ac , target: bw },{source: ac , target: bx },{source: ac , target: ah },{source: ac , target: by },{source: ac , target: bw },{source: ac , target: bv },{source: ac , target: bz },{source: bv , target: bw },{source: bv , target: bx },{source: bv , target: by },{source: bv , target: bw },{source: bv , target: bz } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = 'Fünfter Akt'; var scene = document.getElementById('scene');scene.innerHTML = '2';
}, 210000);
