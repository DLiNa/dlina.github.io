document.getElementById('title').innerHTML = 'Götz von Berlichingen mit der eisernen Hand';
...
setTimeout(function() { console.log('remv2'); var rm = [ 'ai','ai','aj' ]; rmNodes(rm); rmLinks(rm); start(); }, 8750);
...
setTimeout(function() { console.log('remv3'); var rm = [ 'ak','al','am','an','ao','ah','ao' ]; rmNodes(rm); rmLinks(rm); start(); }, 13750);
...
setTimeout(function() { console.log('remv16'); var rm = [ 'bb','bc','bd','bb','ao' ]; rmNodes(rm); rmLinks(rm); start(); }, 78750);
...
setTimeout(function() { console.log('remv22'); var rm = [ 'bj','bk','ah','bj','ai' ]; rmNodes(rm); rmLinks(rm); start(); }, 108750);
...
setTimeout(function() { console.log('remv27'); var rm = [ 'bm','aw','bi','bj','bk','bj','ah','ai' ]; rmNodes(rm); rmLinks(rm); start(); }, 133750);
...
setTimeout(function() { console.log('remv38'); var rm = [ 'bo','bp','bp','bn','bq','br','bf' ]; rmNodes(rm); rmLinks(rm); start(); }, 188750);
...
setTimeout(function() { console.log('remv43'); var rm = [ 'bw','bx','ah','by','bw','ac','bv','bz' ]; rmNodes(rm); rmLinks(rm); start(); }, 213750);
