...
setTimeout(function() { console.log('load29'); var  ad = nodes[0],af = nodes[1],am = {id: 'am', name:'wala'} ; nodes.push( am ); links.push( {source: af , target: am },{source: ad , target: am },{source: ad , target: af } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Szene'; var act = document.getElementById('act');act.innerHTML = '3. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritter Auftritt';
}, 140000);
...
setTimeout(function() { console.log('load31'); var  ad = nodes[0],af = nodes[1],ag = nodes[2],am = nodes[3] ; /* nodes.push(); */ links.push( {source: ag , target: am },{source: ad , target: ag },{source: ad , target: af },{source: ad , target: am },{source: af , target: ag },{source: af , target: am } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Szene'; var act = document.getElementById('act');act.innerHTML = '5. Auftritt'; var scene = document.getElementById('scene');scene.innerHTML = 'Fünfter Auftritt';
}, 150000);
