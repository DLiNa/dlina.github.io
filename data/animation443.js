...
setTimeout(function() { console.log('load16'); var  ab = nodes[0],ad = {id: 'ad', name:'malvizino'},an = nodes[1],ao = {id: 'ao', name:'könig'} ; nodes.push( ad,ao ); links.push( {source: ad , target: ao },{source: ad , target: an },{source: ab , target: ad },{source: ab , target: ao },{source: ab , target: an },{source: an , target: ao } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = 'Dritte Szene';
}, 75000);
