...
setTimeout(function() { console.log('load12'); var  aa = {id: 'aa', name:'die_stimme_des_fremden'},aa = {id: 'aa', name:'die_stimme_des_fremden'},ak = nodes[1],al = nodes[2],am = nodes[3],an = nodes[4],at = nodes[5] ; nodes.push( aa ); links.push( {source: al , target: an },{source: al , target: am },{source: al , target: at },{source: ak , target: al },{source: ak , target: an },{source: ak , target: am },{source: ak , target: at },{source: an , target: at },{source: am , target: an },{source: am , target: at },{source: aa , target: al },{source: aa , target: ak },{source: aa , target: an },{source: aa , target: am },{source: aa , target: at },{source: aa , target: al },{source: aa , target: ak },{source: aa , target: an },{source: aa , target: am },{source: aa , target: at } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = ''; var act = document.getElementById('act');act.innerHTML = '2. Akt'; var scene = document.getElementById('scene');scene.innerHTML = 'II.';
}, 55000);
...
setTimeout(function() { console.log('load17'); var  aa = nodes[0],av = nodes[1] ; /* nodes.push(); */ links.push( {source: aa , target: av } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '3. Szene';
}, 80000);
...
setTimeout(function() { console.log('load19'); var  al = {id: 'al', name:'der_sehende_wächter'},aq = nodes[0],ar = {id: 'ar', name:'marpalye'} ; nodes.push( al,ar ); links.push( {source: aq , target: ar },{source: al , target: ar },{source: al , target: aq } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '5. Akt'; var act = document.getElementById('act');act.innerHTML = '2. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '2. Szene';
}, 90000);
