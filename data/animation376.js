...
setTimeout(function() { console.log('load6'); var  aa = nodes[0],ac = {id: 'ac', name:'traudl'},ad = nodes[1] ; nodes.push( ac ); links.push( {source: ac , target: ad },{source: aa , target: ac },{source: aa , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '6. Scene.';
}, 25000);
...
setTimeout(function() { console.log('load13'); var  ab = nodes[0],ac = {id: 'ac', name:'traudl'},aj = nodes[1] ; nodes.push( ac ); links.push( {source: ac , target: aj },{source: ab , target: aj },{source: ab , target: ac } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '3. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '3. Scene.';
}, 60000);
...
setTimeout(function() { console.log('load17'); var  ab = nodes[0],ag = nodes[1] ; /* nodes.push(); */ links.push( {source: ab , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '2. Akt'; var act = document.getElementById('act');act.innerHTML = '7. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '7. Scene.';
}, 80000);
...
setTimeout(function() { console.log('load25'); var  aa = {id: 'aa', name:'wirt'},ai = nodes[0],ak = {id: 'ak', name:'toni'},am = {id: 'am', name:'nandl'},an = {id: 'an', name:'hochzeitlader'} ; nodes.push( aa,ak,am,an ); links.push( {source: am , target: an },{source: ai , target: am },{source: ai , target: an },{source: ai , target: ak },{source: aa , target: am },{source: aa , target: ai },{source: aa , target: an },{source: aa , target: ak },{source: ak , target: am },{source: ak , target: an } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '3. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '6. Scene.';
}, 120000);
...
setTimeout(function() { console.log('load34'); var  ab = nodes[0],af = nodes[1],ag = {id: 'ag', name:'loni'} ; nodes.push( ag ); links.push( {source: ab , target: af },{source: ab , target: ag },{source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '6. Scene.';
}, 165000);
...
setTimeout(function() { console.log('load36'); var  af = nodes[0],ag = nodes[1] ; /* nodes.push(); */ links.push( {source: af , target: ag } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '4. Akt'; var act = document.getElementById('act');act.innerHTML = '8. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '8. Scene.';
}, 175000);
