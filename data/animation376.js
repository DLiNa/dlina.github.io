setTimeout(function() { console.log('load1'); var  aa = {id: 'aa', name:'wirt'},ab = {id: 'ab', name:'lehnl'},ac = {id: 'ac', name:'traudl'},ad = {id: 'ad', name:'pauli'} ; nodes.push( aa,ab,ac,ad ); links.push( {source: aa , target: ab },{source: aa , target: ac },{source: aa , target: ad },{source: ab , target: ac },{source: ab , target: ad },{source: ac , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '1. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '1. Scene.';
}, 0);
...
setTimeout(function() { console.log('load5'); var  aa = nodes[0],ab = nodes[1],ad = nodes[3],af = nodes[5],ag = {id: 'ag', name:'loni'} ; nodes.push( ag ); links.push( {source: af , target: ag },{source: ab , target: ag },{source: ab , target: af },{source: ab , target: ad },{source: ad , target: ag },{source: ad , target: af },{source: aa , target: ag },{source: aa , target: af },{source: aa , target: ab },{source: aa , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '5. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '5. Scene.';
}, 20000);

setTimeout(function() { console.log('remv5'); var rm = [ 'ag','af','ab' ]; rmNodes(rm); rmLinks(rm); start(); }, 23750);

setTimeout(function() { console.log('load6'); var  aa = nodes[0],ac = {id: 'ac', name:'traudl'},ad = nodes[2] ; nodes.push( ac ); links.push( {source: ac , target: ad },{source: aa , target: ac },{source: aa , target: ad } ); start(); var SomethingBeforeAnAct = document.getElementById('SomethingBeforeAnAct');SomethingBeforeAnAct.innerHTML = '1. Akt'; var act = document.getElementById('act');act.innerHTML = '6. Szene'; var scene = document.getElementById('scene');scene.innerHTML = '6. Scene.';
}, 25000);
